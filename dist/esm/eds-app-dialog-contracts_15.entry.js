...
const ENOVOSAppDialogContracts = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return (h("eds-dialog", { verticalAlignment: "top", class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CONTRACTS}`, disableScroll: true, ignoreBackdropClick: false, onClickBackdropHandler: () => this.displayDialog(false) }, h("div", { slot: "dialog-header" }, h("div", { class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CONTRACTS}${this.classNames.HEADER}` }, h("div", { "margin-top-1": true, "margin-bottom-2": true, "margin-right-4": true }, h("eds-heading", { content: ((_a = this.locale) === null || _a === void 0 ? void 0 : _a.title) || 'Select a contract', "font-weight": "bold", type: "h2", styles: "secondary" })), h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-12": true, "xs-12": true, "sm-12": true, "md-12": true, "lg-6": true, "xlg-6": true }, h("eds-text-field", { class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CONTRACTS}${this.classNames.HEADER}${this.classNames.FIELD}`, placeholder: ((_b = this.locale) === null || _b === void 0 ? void 0 : _b.search) || 'Search', "data-value": this.searchKeywords, "icon-leading": "search", type: "text", onKeyUp: this.onSearchKeyUp })), h("eds-grid-layout-item", { "xxs-12": true, "xs-12": true, "sm-12": true, "md-12": true, "lg-6": true, "xlg-6": true }, h("eds-dropdown", { id: "customers-filter", "autocomplete-on-focus": true, onClickDropdownItem: this.onClickDropdownItem, styles: this.styles, data: this.getCustomers() }, h("div", { slot: "selector" }, h("eds-text-field", { class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CONTRACTS}${this.classNames.HEADER}${this.classNames.FIELD}`, "data-value": this.selectedCustomerName, placeholder: ((_c = this.locale) === null || _c === void 0 ? void 0 : _c.allCustomers) || 'All customers', debounce: 300, "icon-trailing": "chevron-down", "label-inside": ((_d = this.locale) === null || _d === void 0 ? void 0 : _d.filterByCustomers) || 'Filter by customers', "label-styles": this.styles, type: "text", "read-only": true }))))), h("eds-button", { class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CONTRACTS}${this.classNames.CLOSE_BTN}`, onClickButton: () => this.displayDialog(false), styles: "secondary", "text-only": true }, h("eds-icon", { slot: "icon", icon: "times" })))), h("div", { slot: "dialog-body" }, this.contractItems
...
const ENOVOSAppHeader = class {
  ...
  render() {
    return (h("div", { class: this.getComponentClassName() }, h("div", { class: `${this.classNames.EL}__logo` }, h("slot", { name: "logo" })), h("div", { class: `${this.classNames.EL}__language-selector` }, h("slot", { name: "language-selector" })), h("div", { class: `${this.classNames.EL}__user-menu-mobile` }, h("slot", { name: "user-menu-mobile" })), h("div", { class: `${this.classNames.EL}__back-btn` }, h("slot", { name: "back-btn" })), h("div", { class: `${this.classNames.EL}__main` }, h("slot", { name: "main-section" })), h("div", { class: `${this.classNames.EL}__user-menu` }, h("slot", { name: "user-menu" }))));
  }
  get el() { return getElement(this); }
};
  ...
  render() {
    return [
      h("eds-container", { class: [
        ...
        ].join(' ') }, h("div", { class: `${this.classNames.EL}${this.classNames.HEADER}${this.classNames.CONTAINER}` }, h("slot", { name: "header-area" }))),
      this.hasNavigationArea && (h("eds-elevation", { level: "4" }, h("eds-container", { class: [
        ...
        ].join(' ') }, h("span", null, h("slot", { name: "navigation-area" }))))),
      h("eds-container", { class: [
        ...
        ].join(' '), style: this.getBodyStyle() }, h("span", null, h("slot", { name: "main-area" }))),
      h("eds-container", { class: [
        ...
        ].join(' '), style: this.getFooterStyle() }, h("span", null, h("slot", { name: "footer-area" }))),
...
const ENOVOSViewAppEnovosSection404 = class {
  ...
  render() {
    return [
      h("eds-panel", null, h("div", { slot: "body-content" }, h("div", { class: `${this.classNames.EL}__wrapper` }, h("eds-no-results", { "main-title": "Sorry, page not found", subtitle: "It seems that we can't find the page you are looking for", "image-url": "https://storage.googleapis.com/lu-ds-enovos/img/404.svg" }, h("div", { slot: "actions" }, h("eds-button", { content: "Go to overview" })))))),
    ];
  }
  get el() { return getElement(this); }
};
...
const ENOVOSViewAppEnovosSectionConsumption = class {
  ...
  renderChart() {
    switch (this.activeChart) {
      case 'all':
        return [
          h("div", { class: `${this.classNames.EL}__chart-description-list` }, h("span", null, h("eds-paragraph", { type: "body-2", "font-weight": "bold" }, "Total consumption"), h("eds-heading", { type: "h6", content: "11 658 kWh", styles: "secondary" }))),
          h("eds-line-chart", { renderDelay: 0, id: "chart-all", height: 250, minWidth: 540 }),
        ];
      case 'activeReactive':
        return [
          h("div", { class: `${this.classNames.EL}__chart-description-list` }, h("span", null, h("eds-paragraph", { type: "body-2", "font-weight": "bold" }, "Total consumption"), h("eds-heading", { type: "h6", content: "11 658 kWh", styles: "secondary" })), h("span", null, h("eds-paragraph", { type: "body-2", "font-weight": "bold" }, "Total consumption active"), h("eds-heading", { type: "h6", content: "11 658 kWh", styles: "secondary" })), h("span", null, h("eds-paragraph", { type: "body-2", "font-weight": "bold" }, "Total consumption reactive"), h("eds-heading", { type: "h6", content: "11 658 kWh", styles: "secondary" }))),
          h("eds-line-chart", { id: "chart-active-reactive", renderDelay: 0, height: 250, minWidth: 540 }),
        ];
      case 'dayNight':
        return [
          h("div", { class: `${this.classNames.EL}__chart-description-list` }, h("span", null, h("eds-paragraph", { type: "body-2", "font-weight": "bold" }, "Total consumption"), h("eds-heading", { type: "h6", content: "11 658 kWh", styles: "secondary" })), h("span", null, h("eds-paragraph", { type: "body-2", "font-weight": "bold" }, "Total consumption by day"), h("eds-heading", { type: "h6", content: "11 658 kWh", styles: "secondary" })), h("span", null, h("eds-paragraph", { type: "body-2", "font-weight": "bold" }, "Total consumption by night"), h("eds-heading", { type: "h6", content: "11 658 kWh", styles: "secondary" }))),
  ...
  render() {
    return [
      h("eds-panel", { "margin-bottom-4": true, headerTitle: "Consumption in detail", headerWithShadow: true, headerPaddingBottom: "0" }, h("div", { slot: "header-navigation" }, h("eds-navigation", { id: "charts-navigation", position: "top", shrink: true, "text-only": true, activeItem: this.activeChart, items: [
          { id: 'all', text: 'All' },
          { id: 'activeReactive', text: 'Active/Reactive' },
          { id: 'dayNight', text: 'Day/Night' },
        ], styles: this.brand })), h("div", { slot: "header-actions" }, h("eds-button", { content: "Monthly", "icon-position": "right", outlined: true, size: "sm", onClickButton: () => this.showConsumptionGraphDisplaySettingsDialog(), styles: this.brand || 'primary' }, h("eds-icon", { slot: "icon", icon: "chevron-down" })), h("eds-button", { content: "Last year", "icon-position": "right", outlined: true, size: "sm", onClickButton: () => this.showConsumptionGraphDisplaySettingsDialog(), styles: this.brand || 'primary' }, h("eds-icon", { slot: "icon", icon: "calendar-alt" })), h("eds-button", { content: "Download .csv", "icon-position": "right", outlined: true, size: "sm", onClickButton: () => this.showConsumptionDownloadDialog(true), styles: "secondary" }, h("eds-icon", { slot: "icon", icon: "download" }))), h("div", { slot: "body-content" }, this.renderChart())),
      h("eds-panel", { "margin-bottom-4": true, headerPaddingBottom: "0", headerNoMinHeight: true, headerTitle: "Periodic consumption" }, h("div", { slot: "body-content" }, h("eds-grid-layout", null, h("eds-grid-layout-item", { "margin-top-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-4": true, "xlg-4": true }, h("eds-app-periodic-consumption", { styles: this.brand, "first-item-title": "Period", "first-item-value": "12.01.2018 - 12.11.2018", "second-item-title": "Total consumption", "second-item-value": "648 kWh", "chart-max-value": "1000", "chart-min-value": "0", "chart-value": "648" })), h("eds-grid-layout-item", { "margin-top-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-4": true, "xlg-4": true }, h("eds-app-periodic-consumption", { styles: this.brand, "first-item-title": "Period", "first-item-value": "12.11.2028 - 12.11.2019", "second-item-title": "Total consumption", "second-item-value": "700 kWh", "second-item-caption-icon": "arrow-up", "second-item-caption-styles": "error", "second-item-caption-text": "52 kWh", "chart-max-value": 1000, "chart-min-value": 0, "chart-value": 700 })), h("eds-grid-layout-item", { "margin-top-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-4": true, "xlg-4": true }, h("eds-app-periodic-consumption", { styles: this.brand, "first-item-title": "Period", "first-item-value": "12.11.2019 - 12.11.2020", "second-item-title": "Total consumption", "second-item-value": "Pending", "chart-max-value": 1000, "chart-min-value": 0, "chart-value": 0 }))))),
      h("eds-panel", { headerPaddingBottom: "0", bodyPaddingLeft: "0", bodyPaddingRight: "0", headerNoMinHeight: true, headerTitle: "Comparison profile" }, h("div", { slot: "header-actions" }, h("eds-button", { content: "Filter", size: "sm", onClickButton: () => { alert('onClickButton'); }, styles: "secondary", outlined: true, iconPosition: "right" }, h("eds-icon", { slot: "icon", icon: "sliders-h" })), h("eds-button", { content: "Collapse all", size: "sm", styles: "secondary", onClickButton: () => this.collapseComparisonProfile(), outlined: true, iconPosition: "right" }, h("eds-icon", { slot: "icon", icon: "minus" }))), h("div", { slot: "body-content" }, h("eds-datalist", { alternate: true, id: "comparison-profile-january", class: `${this.classNames.EL}${this.classNames.COMPARISON_PROFILE}${this.classNames.DATALIST}` }), h("eds-datalist", { alternate: true, id: "comparison-profile-february", class: `${this.classNames.EL}${this.classNames.COMPARISON_PROFILE}${this.classNames.DATALIST}` }), h("eds-datalist", { alternate: true, id: "comparison-profile-march", class: `${this.classNames.EL}${this.classNames.COMPARISON_PROFILE}${this.classNames.DATALIST}` }), h("eds-datalist", { alternate: true, id: "comparison-profile-april", class: `${this.classNames.EL}${this.classNames.COMPARISON_PROFILE}${this.classNames.DATALIST}` }), h("eds-datalist", { alternate: true, id: "comparison-profile-may", class: `${this.classNames.EL}${this.classNames.COMPARISON_PROFILE}${this.classNames.DATALIST}` }), h("eds-datalist", { alternate: true, id: "comparison-profile-june", class: `${this.classNames.EL}${this.classNames.COMPARISON_PROFILE}${this.classNames.DATALIST}` }))),
      ...
      h("eds-advanced-dialog", { id: "consumption-graph-display-settings", headerTitle: "Consumption graph display settings", headerSubtitle: "Pick data timeline and frequency to display on consumption graph", bodyScrollDisabled: true }, h("eds-grid-layout", { alignCenter: true }, h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-date-picker", { onClickDatePicker: () => { alert('onClickDatePicker'); }, styles: this.brand || 'primary' }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": "From 17.07.2019 to 17.07.2020", placeholder: "From 17.07.2019 to 17.07.2020", "icon-trailing": "calendar-alt", "label-inside": "Data timeline", "label-styles": this.brand || 'primary', type: "text", "read-only": true })))), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-text-field", { "data-value": "Every quarter hour", placeholder: "Data frequency", "label-inside": "Data frequency", "icon-trailing": "chevron-down", "label-styles": this.brand || 'primary', type: "text" }))), h("div", { slot: "footer-right" }, h("eds-button", { styles: this.brand || 'primary', content: "Confirm changes" }))),
    ];
  }
  get el() { return getElement(this); }
};
...
const ENOVOSViewAppEnovosSectionContractDetails = class {
  ...
  render() {
    return [
      h("eds-elevation", { level: "5" }, h("eds-card", { "no-border": true, class: `${this.classNames.EL}${this.classNames.CARD}` }, h("div", { slot: "card-content" }, h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("div", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.CONTENT}` }, h("eds-heading", { content: "Contract details", "font-weight": "bold", type: "h2", styles: "secondary" }), h("div", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.CONTENT}${this.classNames.FIELD}` }, h("eds-paragraph", { type: "body-2", fontWeight: "bold", content: "Contract ID" }), h("eds-heading", { type: "h6", content: "0003317731", styles: "secondary" })), h("div", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.CONTENT}${this.classNames.FIELD}` }, h("eds-paragraph", { type: "body-2", fontWeight: "bold", content: "Starting date" }), h("eds-heading", { type: "h6", content: "04.11.2019", styles: "secondary" })), h("div", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.CONTENT}${this.classNames.FIELD}` }, h("eds-paragraph", { type: "body-2", fontWeight: "bold", content: "Meter number" }), h("eds-heading", { type: "h6", content: "SAG1030700119520", styles: "secondary" })), h("div", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.CONTENT}${this.classNames.FIELD}` }, h("eds-paragraph", { type: "body-2", fontWeight: "bold", content: "POD number" }), h("eds-heading", { type: "h6", content: "LU 0000 0802 5422 4820 0002 0012 ELE0 0000", styles: "secondary" })), h("div", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.CONTENT}${this.classNames.FIELD}` }, h("eds-paragraph", { type: "body-2", fontWeight: "bold", content: "Consumption address" }), h("eds-heading", { type: "h6", content: "4 place de Strasbourg, 2562, Luxembourg, LU", styles: "secondary" })), h("div", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.CONTENT}${this.classNames.BUTTON}` }, h("eds-button", { content: "Close contract", outlined: true, styles: "secondary", onClickButton: () => this.closeContract() })))), h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("iframe", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.MAP}`, src: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2585.8334337749297!2d6.126005015910103!3d49.60089045609219!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479548d0a13723b9%3A0xe919d3096f187f4!2s4%20Place%20de%20Strasbourg%2C%202562%20Luxembourg!5e0!3m2!1sfr!2sfr!4v1606203908630!5m2!1sfr!2sfr", frameborder: "0", "aria-hidden": "false", tabindex: "0" })))))),
    ];
  }
  get el() { return getElement(this); }
};
...
const ENOVOSViewAppEnovosSectionContractList = class {
  ...
  render() {
    var _a;
    return [
      h("eds-page-header", { pageTitle: "All contracts" }, h("div", { slot: "actions" }, h("eds-button", { content: "Download consumption", styles: "secondary", outlined: true, "icon-position": "right", size: "md", onClick: this.showConsumptionDownloadDialog }, h("eds-icon", { slot: "icon", icon: "download" })), h("eds-button", { content: "Connect new", styles: "secondary", outlined: true, "icon-position": "right", size: "md" }, h("eds-icon", { slot: "icon", icon: "plus" })))),
      h("eds-panel", { headerTitle: "Contracts in detail", headerPaddingTop: "2", headerPaddingBottom: "2", headerWithShadow: true }, h("div", { slot: "header-actions" }, h("div", { class: `${this.classNames.EL}__search-field` }, h("eds-text-field", { placeholder: 'Search', "icon-leading": "search", type: "text" })), h("div", { class: `${this.classNames.EL}__filter` }, h("eds-dropdown", { id: "status-filter", styles: this.brand, "autocomplete-on-focus": true, onClickDropdownItem: () => alert('onClickDropdownItem'), data: [
          { label: 'item 1' },
          { label: 'item 2' },
        ] }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": 'Active', "icon-trailing": "chevron-down", "label-inside": 'Status', "label-styles": this.brand, type: "text", "read-only": true })))), h("div", { class: `${this.classNames.EL}__filter` }, h("eds-dropdown", { id: "type-filter", styles: this.brand, "autocomplete-on-focus": true, onClickDropdownItem: () => alert('onClickDropdownItem'), data: [
          { label: 'item 1' },
          { label: 'item 2' },
        ] }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": 'All', "icon-trailing": "chevron-down", "label-inside": 'Type', "label-styles": this.brand, type: "text", "read-only": true }))))), h("div", { slot: "body-content" }, h("eds-data-table", { id: "contracts-list", onClickRowCellButton: e => this.manageClickRowButton(e) }))),
      h("eds-advanced-dialog", { id: "consumption-download-dialog", headerTitle: "Consumption download", headerWithShadow: true, footerWithShadow: true }, h("div", { slot: "header-content" }, h("eds-grid-layout", { alignCenter: true }, h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-date-picker", { onClickDatePicker: () => { alert('onClickDatePicker'); } }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": 'From 17.07.2019 to 17.07.2020', placeholder: 'From 17.07.2019 to 17.07.2020', "icon-trailing": "calendar-alt", "label-inside": 'Data timeline', "label-styles": this.brand, type: "text", "read-only": true })))), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-text-field", { "data-value": "Every quarter hour", placeholder: "Data frequency", "label-inside": "Data frequency", "label-styles": this.brand, "info-tooltip-text": "tooltip", "info-tooltip-icon": "exclamation-circle", "info-tooltip-size": "3", "info-tooltip-styles": this.brand, type: "text" })), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-text-field", { placeholder: 'Search', "icon-leading": "search", type: "text" })), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-dropdown", { id: "customers-filter", styles: this.brand, "autocomplete-on-focus": true, onClickDropdownItem: () => { alert('onClickDropdownItem'); }, data: [
          {
            label: 'Item 1',
          },
          {
        ...
        ] }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": 'All customers', placeholder: 'All customers', debounce: 300, "icon-trailing": "chevron-down", "label-inside": 'Filter by customers', "label-styles": this.brand, type: "text", "read-only": true })))))), h("div", { slot: "footer-left" }, h("eds-button", { styles: "secondary", content: "Reset all", "text-only": true })), h("div", { slot: "footer-right" }, h("eds-button", { styles: this.brand, content: "Download 2 .csv" })), ((_a = this.consumptionDownloadItems) === null || _a === void 0 ? void 0 : _a.length) > 0 && this.consumptionDownloadItems.map(item => h("eds-contract-item", { "is-checkable": true, "is-checked": true, status: item.status, type: item.type, "customer-id": item.customerId, "customer-name": item.customerName, "contract-id": item.contractId, "contract-address": item.contractAddress, onClickItem: () => { alert('onClickItem'); }, onClickItemCheckbox: () => { alert('onClickItemCheckbox'); }, styles: this.brand }))),
    ];
  }
  get el() { return getElement(this); }
};
...
const ENOVOSViewAppEnovosSectionContractListEmpty = class {
  ...
  render() {
    return [
      h("eds-page-header", { pageTitle: "All contracts" }, h("div", { slot: "actions" }, h("eds-button", { content: "Download consumption", styles: "secondary", outlined: true, "icon-position": "right", size: "md" }, h("eds-icon", { slot: "icon", icon: "download" })), h("eds-button", { content: "Connect new", styles: "secondary", outlined: true, "icon-position": "right", size: "md" }, h("eds-icon", { slot: "icon", icon: "plus" })))),
      h("eds-panel", { headerTitle: "Contracts in detail", headerPaddingTop: "2", headerPaddingBottom: "2", headerWithShadow: true }, h("div", { slot: "header-actions" }, h("div", { class: `${this.classNames.EL}__search-field` }, h("eds-text-field", { placeholder: 'Search', "icon-leading": "search", type: "text" })), h("div", { class: `${this.classNames.EL}__filter` }, h("eds-dropdown", { id: "status-filter", "autocomplete-on-focus": true, onClickDropdownItem: () => alert('onClickDropdownItem'), data: [
          { label: 'item 1' },
          { label: 'item 2' },
        ] }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": 'Active', "icon-trailing": "chevron-down", "label-inside": 'Status', type: "text", "read-only": true })))), h("div", { class: `${this.classNames.EL}__filter` }, h("eds-dropdown", { id: "type-filter", "autocomplete-on-focus": true, onClickDropdownItem: () => alert('onClickDropdownItem'), data: [
          { label: 'item 1' },
          { label: 'item 2' },
        ] }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": 'All', "icon-trailing": "chevron-down", "label-inside": 'Type', type: "text", "read-only": true }))))), h("div", { slot: "body-content" }, h("div", { class: `${this.classNames.EL}__no-results` }, h("eds-no-results", { "main-title": "Sorry, no results found", subtitle: "Unfortunately no contract is matching your selected criteria", "image-url": "https://storage.googleapis.com/lu-ds-enovos/img/no-results.svg" }, h("div", { slot: "actions" }, h("eds-button", { content: "Start over", styles: "primary" })))))),
    ];
  }
  get el() { return getElement(this); }
};
...
const ENOVOSViewAppEnovosSectionIAmMovingSingleContract = class {
  constructor(hostRef) {
    ...
    this.renderAddressStep = () => (h("eds-panel", { "header-title": "New address", "header-padding-bottom": "0", "header-no-min-height": true }, h("div", { slot: "body-content" }, h("eds-fields-group", null, h("eds-checkbox", { styles: this.brand || 'primary', inputName: "closeContract", value: "1", label: "I am moving out of Luxembourg and I want to close my contract", size: "md" })), h("eds-fields-group", { "main-title": "Address details" }, h("eds-grid-layout", { "margin-bottom-1": true }, h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-text-field", { "label-inside": "Street*", "label-styles": this.brand || 'primary', type: "text" })), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-2": true, "xs-2": true, "sm-2": true, "md-3": true, "lg-3": true, "xlg-3": true }, h("eds-text-field", { "label-inside": "Number*", "label-styles": this.brand || 'primary', type: "text" })), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-2": true, "xs-2": true, "sm-2": true, "md-3": true, "lg-3": true, "xlg-3": true }, h("eds-text-field", { "label-inside": "Floor", "label-styles": this.brand || 'primary', type: "text" })), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-2": true, "md-3": true, "lg-3": true, "xlg-3": true }, h("eds-text-field", { "label-inside": "Zip code*", "label-styles": this.brand || 'primary', type: "text" })), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-6": true, "md-9": true, "lg-9": true, "xlg-9": true }, h("eds-text-field", { "label-inside": "City*", "label-styles": this.brand || 'primary', type: "text" })))), h("eds-fields-group", { "main-title": "Invoice address" }, h("eds-checkbox", { styles: this.brand || 'primary', inputName: "sameInvoiceAddress", value: "1", label: "Invoice address remains the same", size: "md" })))));
    this.renderDatesAndEnergyStep = () => [
      h("eds-panel", { "header-title": "End of supply in current address", "header-subtitle": "Please choose energy sources available at your current address", "header-padding-bottom": "0", "header-no-min-height": true }, h("div", { slot: "body-content" }, h("eds-expandable-card", { isDefaultChecked: true, hideCheckbox: true, onClickCheckbox: () => { alert('onClickCheckbox'); }, icon: `https://storage.googleapis.com/lu-ds-enovos/img/icons/energy-electricity.svg`, mainTitle: "Electricity", styles: this.brand }, h("div", { slot: "expandable-content" }, h("eds-fields-group", null, h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-grid-layout", null, h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-12": true, "xlg-12": true }, h("eds-date-picker", { onClickDatePicker: () => { alert('onClickDatePicker'); }, styles: this.brand || 'primary' }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": '', "label-inside": "End of supply date*", "label-styles": this.brand || 'primary', "icon-trailing": "calendar-alt", type: "text", "read-only": true })))), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-12": true, "xlg-12": true }, h("eds-text-field", { type: "text", "label-inside": "Meter number*", "label-styles": this.brand || 'primary' }))))), h("eds-grid-layout", null, h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-text-field", { type: "text", "label-inside": "Index statement 1", "label-styles": this.brand || 'primary', "info-tooltip-text": "tooltip", "info-tooltip-icon": "exclamation-circle", "info-tooltip-size": "3", "info-tooltip-styles": this.brand })), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-text-field", { type: "text", "label-inside": "Index statement 2", "label-styles": this.brand || 'primary', "info-tooltip-text": "tooltip", "info-tooltip-icon": "exclamation-circle", "info-tooltip-size": "3", "info-tooltip-styles": this.brand })))), h("eds-fields-group", { "main-title": "Meter photos", "tooltip-content": "tooltip" }, h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-2": true, "xs-2": true, "sm-4": true, "md-4": true, "lg-4": true, "xlg-4": true }, h("eds-uploaded-image", { imageSrc: "https://storage.googleapis.com/lu-ds-enovos/img/example-meter.png", fileName: "example-meter.png", fileSize: "254 kb", height: "112px", onClickView: () => { alert('onClickView'); }, onClickRemove: () => { alert('onClickRemove'); } })), h("eds-grid-layout-item", { "xxs-2": true, "xs-2": true, "sm-4": true, "md-4": true, "lg-4": true, "xlg-4": true }, h("eds-upload-dragger", { styles: this.brand || 'primary', height: "112px" }, h("div", { slot: "text" }, "Drag files to upload ", h("br", null), "or ", h("strong", null, "choose file")))))))), h("eds-expandable-card", { isDefaultChecked: false, onClickCheckbox: () => { alert('onClickCheckbox'); }, icon: `https://storage.googleapis.com/lu-ds-enovos/img/icons/energy-gas.svg`, mainTitle: "Gas", styles: this.brand }))),
      h("eds-panel", { "header-title": "Beginning of supply in new address", "header-subtitle": "Please choose energy sources available at you new address", "header-padding-bottom": "0", "header-no-min-height": true }, h("div", { slot: "body-content" }, h("eds-fields-group", null, h("eds-grid-layout", { alignCenter: true }, h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-dropdown", { id: "customers-filter", styles: this.brand, "autocomplete-on-focus": true, onClickDropdownItem: () => { alert('onClickDropdownItem'); }, data: [
          {
            label: 'Item 1',
          },
          {
        ...
        ] }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": 'Naturstroum', placeholder: 'Recommended product', debounce: 300, "icon-trailing": "chevron-down", "label-inside": 'Recommended product', "label-styles": this.brand, type: "text", "read-only": true })))), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-button", { onClickButton: () => { this.showProductsComparisonDialog(); }, styles: "primary", "text-only": true, content: "Compare products", size: "md" }))), h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-grid-layout", null, h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-12": true, "xlg-12": true }, h("eds-date-picker", { onClickDatePicker: () => { alert('onClickDatePicker'); }, styles: this.brand || 'primary' }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": '', "icon-trailing": "calendar-alt", "label-inside": "Beginning of supply date*", "label-styles": this.brand || 'primary', type: "text", "read-only": true })))), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-12": true, "xlg-12": true }, h("eds-text-field", { type: "text", "label-inside": "Meter number*", "label-styles": this.brand || 'primary' }))))), h("eds-grid-layout", null, h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-text-field", { type: "text", "label-inside": "Index statement 1", "label-styles": this.brand || 'primary', "info-tooltip-text": "tooltip", "info-tooltip-icon": "exclamation-circle", "info-tooltip-size": "3", "info-tooltip-styles": this.brand })), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-text-field", { type: "text", "label-inside": "Index statement 2", "label-styles": this.brand || 'primary', "info-tooltip-text": "tooltip", "info-tooltip-icon": "exclamation-circle", "info-tooltip-size": "3", "info-tooltip-styles": this.brand })))), h("eds-fields-group", { "main-title": "Meter photos", "tooltip-content": "tooltip" }, h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-2": true, "xs-2": true, "sm-4": true, "md-4": true, "lg-4": true, "xlg-4": true }, h("eds-upload-dragger", { styles: this.brand || 'primary', height: "112px" }, h("div", { slot: "text" }, "Drag files to upload ", h("br", null), "or ", h("strong", null, "choose file")))))))),
      h("eds-panel", { "header-title": "Connect discount", "header-subtitle": "Save 30 euros in first year by activating paperless invoice and SEPA domiciliation", "header-padding-bottom": "0", "header-no-min-height": true }, h("div", { slot: "body-content" }, h("eds-expandable-card", { isDisabled: true, isRadio: true, onClickCheckbox: () => { alert('onClickCheckbox'); }, icon: `https://storage.googleapis.com/lu-ds-enovos/img/icons/discount-${this.brand || 'primary'}.svg`, mainTitle: "Activate Connect Discount", styles: this.brand }, h("div", { slot: "expandable-content" }, h("eds-paragraph", { type: "body-1", "font-weight": "bold" }, "To use Discount connect, SEPA domiciliation should be activated first"), h("div", { "margin-top-1": true }, h("span", { class: `${this.classNames.EL}__icon-text` }, h("span", null, h("eds-icon", { icon: "times", styles: "secondary" })), h("span", null, h("eds-paragraph", { styles: "secondary", type: "body-1" }, "SEPA domiciliation"))), h("span", { class: `${this.classNames.EL}__sepa-btn` }, h("eds-button", { styles: this.brand || 'primary', size: "sm", content: "Activate SEPA", "icon-position": "right" }, h("eds-icon", { slot: "icon", icon: "chevron-right" })))), h("div", { "margin-top-1": true }, h("span", { class: `${this.classNames.EL}__icon-text` }, h("span", null, h("eds-icon", { icon: "check", styles: this.brand || 'primary' })), h("span", null, h("eds-paragraph", { styles: this.brand || 'primary', type: "body-1" }, "Paperless invoice")))))))),
    ];
    ...
    this.renderConfirmationStep = () => [
      h("eds-panel", { "header-title": "Confirmation", "header-subtitle": "Please check if everything is correct", "header-padding-bottom": "0", "header-no-min-height": true }, h("div", { slot: "body-content" }, h("eds-fields-group", { "main-title": "Contact data" }, h("eds-grid-layout", null, [
        {
          title: 'Customer ID',
          value: '00000000000',
        },
      ...
      ].map(item => h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-2": true, "xs-2": true, "sm-2": true, "md-4": true, "lg-4": true, "xlg-4": true }, this.renderDescriptionListItem(item.title, item.value))))), h("eds-fields-group", { "main-title": "Current address" }, h("div", null, this.renderDescriptionListItem('Address', '31 Domaine du Schlassgoard, 4327, Esch-sur-Alzette, LU'))), h("eds-fields-group", { "main-title": "New address" }, h("div", null, this.renderDescriptionListItem('Address', '2 Place de Strasbourg, 4th floor, 1631, Luxembourg Ville, LU'))), h("eds-fields-group", { "main-title": "Contact data" }, h("eds-grid-layout", null, [
        {
          title: 'Energy type',
          value: 'Electricity',
        },
      ...
      ].map(item => h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-2": true, "xs-2": true, "sm-2": true, "md-4": true, "lg-4": true, "xlg-4": true }, this.renderDescriptionListItem(item.title, item.value)))), h("div", { "margin-top-1": true, "margin-bottom-1": true }, this.renderDescriptionListItem('Meter photos', h("div", { "margin-top-1": true }, h("eds-uploaded-image", { imageSrc: "https://storage.googleapis.com/lu-ds-enovos/img/example-meter.png", fileName: "example-meter.png", fileSize: "254 kb", variation: "list-item" }), h("eds-uploaded-image", { imageSrc: "https://storage.googleapis.com/lu-ds-enovos/img/example-meter.png", fileName: "example-meter.png", fileSize: "254 kb", variation: "list-item" }))))), h("eds-fields-group", { "main-title": "Beginning of supply in new address" }, h("eds-grid-layout", null, [
        {
          title: 'Energy type',
          value: 'Electricity',
        },
      ...
      ].map(item => h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-2": true, "xs-2": true, "sm-2": true, "md-4": true, "lg-4": true, "xlg-4": true }, this.renderDescriptionListItem(item.title, item.value))))), h("eds-fields-group", { "main-title": "Selected electricity offer for new address" }, h("eds-grid-layout", null, [
        {
          title: 'Product name',
      ...
      h("div", { "margin-top-3": true, "margin-left-3": true }, h("eds-checkbox", { styles: this.brand || 'primary', inputName: "closeContract", value: "1", label: "I have read and accept the privacy as well as the general conditions of use", size: "md" })),
    ];
    this.renderPreviousAction = () => {
      switch (this.activeStepId) {
        case 'address':
          return undefined;
        case 'dates-and-energy':
          return (h("eds-button", { content: "Previous step", styles: "secondary", outlined: true, onClickButton: () => { this.activeStepId = 'address'; } }, h("eds-icon", { icon: "chevron-left", slot: "icon" })));
        case 'confirmation':
          return (h("eds-button", { content: "Previous step", styles: "secondary", outlined: true, onClickButton: () => { this.activeStepId = 'dates-and-energy'; } }, h("eds-icon", { icon: "chevron-left", slot: "icon" })));
        default:
          return undefined;
      }
    };
  ...
  render() {
    return [
      ...
      h("eds-container", { size: "sm" }, h("eds-steps", { id: "steps", styles: this.brand || 'primary', activeItemId: this.activeStepId, items: [
          {
            id: 'address',
            title: 'Address',
        ...
        ] }), this.renderCurrentStep(), h("eds-grid-layout", { "margin-top-4": true }, h("eds-grid-layout-item", { "xxs-2": true, "xs-2": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, this.renderPreviousAction()), h("eds-grid-layout-item", { alignContent: "right", "xxs-2": true, "xs-2": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, this.renderNextAction()))),
      h("eds-advanced-dialog", { id: "products-comparison", headerTitle: "Electricity product selection", headerIconUrl: "https://storage.googleapis.com/lu-ds-enovos/img/icons/energy-electricity.svg", headerSubtitle: "Select a product and calculate the price" }, h("eds-grid-layout", { "margin-bottom-2": true }, h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-2": true, "md-4": true, "lg-4": true, "xlg-4": true }, h("eds-dropdown", { id: "number-of-people", styles: this.brand, "autocomplete-on-focus": true, onClickDropdownItem: () => { alert('onClickDropdownItem'); }, data: [
          {
            label: 'Item 1',
          },
          {
        ...
        ] }, h("div", { slot: "selector" }, h("eds-text-field", { "data-value": '4', placeholder: 'Number of people', debounce: 300, "icon-trailing": "chevron-down", "label-inside": 'Number of people', "label-styles": this.brand, type: "text", "read-only": true })))), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-3": true, "md-4": true, "lg-4": true, "xlg-4": true }, h("eds-text-field", { type: "text", "label-inside": "Annual consumption", "label-styles": this.brand || 'primary', "info-tooltip-text": "tooltip", "info-tooltip-icon": "exclamation-circle", "info-tooltip-size": "3", "info-tooltip-styles": this.brand })), h("eds-grid-layout-item", { "margin-top-1": true, "margin-bottom-1": true, "xxs-4": true, "xs-4": true, "sm-3": true, "md-4": true, "lg-4": true, "xlg-4": true }, h("eds-button", { styles: this.brand || 'primary', content: "Calculate", expand: true, outlined: true }))), h("eds-pricing-table", { styles: this.brand || 'primary', selectedItem: this.selectedProductId, recommendedItem: "naturstroum", inputName: "electricityProductSelection", onClickItem: e => { this.selectedProductId = e.detail; }, items: [
          {
            id: 'fix-naturstroum',
...
const ENOVOSViewAppEnovosSectionInvoices = class {
  ...
  render() {
    return [
      h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-8": true, "lg-8": true, "xlg-8": true }, h("eds-panel", { "header-title": "List of invoices", "header-padding-bottom": "0", "header-no-min-height": true }, h("div", { slot: "header-actions" }, h("eds-button", { content: "All available", "icon-position": "right", outlined: true, size: "sm", styles: "secondary" }, h("eds-icon", { slot: "icon", icon: "calendar-alt" }))), h("div", { slot: "body-content" }, h("eds-data-table", { id: "invoices-data-table", onClickRowCellButton: () => { alert('onClickRowCellButton'); } })))), h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-4": true, "lg-4": true, "xlg-4": true, stretchColumn: true, alignContent: "right" }, h("eds-panel", { "header-title": "Payment settings", "header-padding-bottom": "0", "header-no-min-height": true }, h("div", { slot: "body-content" }, this.quickActions.map(item => h("eds-quick-action", { id: item.id, onClickItem: (e) => this.manageQuickActionClick(e.detail.id), styles: this.brand, icon: item.icon, "main-title": item.title }, h("div", { slot: "after-titles" }, h("eds-badge", { text: "Activated", styles: "success" })))))))),
      h("eds-advanced-dialog", { id: "consumption-calculation-dialog", headerTitle: "Consumption calculation method for 000800148000 - Naturstorum Home Mono" }, h("eds-expandable-card", { isDefaultChecked: this.consumptionCalculationMethod === 'fixed', onClickCheckbox: () => { this.consumptionCalculationMethod = this.consumptionCalculationMethod === 'fixed' ? '' : 'fixed'; }, isRadio: true, icon: `https://storage.googleapis.com/lu-ds-enovos/img/icons/consumption-fixed${this.brand && this.brand !== 'primary' ? `-${this.brand}` : ''}.svg`, mainTitle: "Fixed payment", subtitle: "Periodic estimation of consumption", styles: this.brand }), h("eds-expandable-card", { isDefaultChecked: this.consumptionCalculationMethod === 'payAsYouGo', onClickCheckbox: () => { this.consumptionCalculationMethod = this.consumptionCalculationMethod === 'payAsYouGo' ? '' : 'payAsYouGo'; }, isRadio: true, icon: `https://storage.googleapis.com/lu-ds-enovos/img/icons/consumption-smart${this.brand && this.brand !== 'primary' ? `-${this.brand}` : ''}.svg`, mainTitle: "Pay as you go", subtitle: "Pay for what you actually use", styles: this.brand }, h("div", { slot: "expandable-content" }, h("eds-paragraph", { type: "body-1", "font-weight": "bold" }, "To use this method, SEPA domiciliation should be activated first"), h("div", { "margin-top-1": true }, h("span", { class: `${this.classNames.EL}__icon-text` }, h("span", null, h("eds-icon", { icon: "times", styles: "secondary" })), h("span", null, h("eds-paragraph", { styles: "secondary", type: "body-1" }, "SEPA domiciliation"))), h("span", { class: `${this.classNames.EL}__sepa-btn` }, h("eds-button", { styles: this.brand || 'primary', size: "sm", content: "Activate SEPA", "icon-position": "right" }, h("eds-icon", { slot: "icon", icon: "chevron-right" })))), h("div", { "margin-top-1": true }, h("span", { class: `${this.classNames.EL}__icon-text` }, h("span", null, h("eds-icon", { icon: "check", styles: this.brand || 'primary' })), h("span", null, h("eds-paragraph", { styles: this.brand || 'primary', type: "body-1" }, "Paperless invoice"))))))),
    ];
  }
  get el() { return getElement(this); }
};
...
const ENOVOSViewAppEnovosSectionLandingPage = class {
  ...
  render() {
    return [
      ...
      h("eds-container", { size: "sm" }, h("eds-panel", { "header-title": "Login to you account now!", "header-subtitle": "Get easy access to", "header-padding-bottom": "0", "header-no-min-height": true, "body-padding-top": "1" }, h("div", { slot: "body-content" }, h("ul", { class: `${this.classNames.EL}__list` }, h("li", null, h("eds-paragraph", { type: "body-1", content: "Your invoices" })), h("li", null, h("eds-paragraph", { type: "body-1", content: "Your contracts" })), h("li", null, h("eds-paragraph", { type: "body-1", content: "You consumption data" }))), h("eds-grid-layout", null, h("eds-grid-layout-item", { "margin-top-1": true, "align-content": "right", "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-12": true, "xlg-12": true }, h("span", null, h("eds-button", { onClickButton: () => { alert("click"); }, styles: this.brand || 'primary', content: "Log in" }))))), h("div", { slot: "footer-content" }, h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-paragraph", { type: "body-1", "font-weight": "bold", content: "Don't have an account ?" })), h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true, "align-content": "right" }, h("eds-button", { onClickButton: () => { alert('click'); }, styles: "secondary", content: "Register", size: "sm", outlined: true, "icon-position": "right" }, h("eds-icon", { slot: "icon", icon: "chevron-right" })))))), h("eds-panel", { "margin-top-4": true, "header-title": "Become a customer", "header-subtitle": "100% natural Electricity or Gas for your home", "body-padding-top": "0" }, h("div", { slot: "body-content" }, h("eds-grid-layout", null, h("eds-grid-layout-item", { "margin-top-3": true, "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-expandable-card", { isRadio: true, inputName: "energy-type", onClickCheckbox: () => { alert('click'); }, icon: "https://storage.googleapis.com/lu-ds-enovos/img/icons/energy-producer.svg", mainTitle: "Electricity", styles: this.brand || 'primary' })), h("eds-grid-layout-item", { "margin-top-3": true, "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-expandable-card", { isRadio: true, inputName: "energy-type", onClickCheckbox: () => { alert('click'); }, icon: "https://storage.googleapis.com/lu-ds-enovos/img/icons/energy-gas.svg", mainTitle: "Gas", styles: this.brand || 'primary' })), h("eds-grid-layout-item", { "margin-top-3": true, "align-content": "right", "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-12": true, "xlg-12": true }, h("span", null, h("eds-button", { onClickButton: () => { alert("click"); }, styles: this.brand || 'primary', content: "Show the offer" }))))))),
    ];
  }
  get el() { return getElement(this); }
};
...
const ENOVOSViewAppEnovosSectionMyAccountMultiple = class {
  ...
  render() {
    if (this.variation === 'detail') {
      return [
        h("eds-page-header", { "page-title": "Enovos Luxembourg S.A." }, h("div", { slot: "before-title" }, h("a", null, h("eds-icon", { styles: "secondary", slot: "icon", icon: "arrow-left", size: "6x" })))),
        h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-6": true, "xlg-6": true }, h("eds-elevation", { level: "5" }, h("eds-card", { "no-border": true }, h("div", { slot: "card-content" }, h("eds-card", { styles: this.brand || 'primary' }, h("div", { slot: "card-content" }, h("div", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.BILLING}` }, h("eds-heading", { type: "h6", fontWeight: "bold", "margin-bottom-2": true, content: "This address is used for your billing only", styles: "secondary" }), h("eds-paragraph", { type: "body-2", "margin-bottom-2": true, content: "Changing this address does not mean that we will move your contract.<br />If you want to change where contract will be used, please click the button below.", styles: "secondary-500" }), h("eds-button", { outlined: true, size: "md", content: "I'm moving" })))), h("div", null, h("eds-heading", { type: "h5", fontWeight: "bold", "margin-top-2": true, "margin-bottom-2": true, content: "Billing data", styles: "secondary" }), this.blockData2.map(data => h("eds-app-data-block", { onClickDataBlock: e => this.clickDataBlockHander(e), data: data })))))))),
        h("eds-dialog", { class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CHANGE_PASSWORD}`, columns: 6 }, h("div", { slot: "dialog-header" }, h("div", { class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.HEADER}` }, h("eds-heading", { type: "h5", "font-weight": "bold", styles: "left secondary-500", content: "Please check your email" }), h("eds-button", { size: "sm", textOnly: true, styles: "secondary", onClickButton: () => this.closeDialog(`.${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CHANGE_PASSWORD}`) }, h("eds-icon", { slot: "icon", icon: "times" })))), h("div", { slot: "dialog-body" }, h("eds-paragraph", { type: "body-1", styles: "left secondary-500" }, "You should receive link to reset your password on your email address gilles.hermes@enovos.lu. For further steps, follow email instructions.")), h("div", { slot: "dialog-footer" }, h("div", { class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.FOOTER}` }, h("eds-button", { content: "Done", onClickButton: () => this.closeDialog(`.${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CHANGE_PASSWORD}`), styles: "primary" })))),
      ];
    }
    return [
      h("eds-panel", { headerTitle: "Connected Customer IDs", headerNoMinHeight: true, headerPaddingBottom: "0" }, h("div", { slot: "header-actions" }, h("div", null, h("eds-button", { content: "Connect new", "icon-position": "right", outlined: true, size: "md", styles: "secondary" }, h("eds-icon", { slot: "icon", icon: "plus" }))), h("div", null, h("eds-text-field", { placeholder: 'Search', "icon-leading": "search", size: "sm", type: "text" }))), h("div", { slot: "body-content" }, h("eds-data-table", { id: "connected-customer-ids-data-table" }), h("eds-mobile-data-table", { id: "connected-customer-ids-mobile-data-table" }))),
    ];
  }
  get el() { return getElement(this); }
};
...
const ENOVOSViewAppEnovosSectionMyAccountSingle = class {
  ...
  render() {
    return [
      h("eds-page-header", { "page-title": "My account" }, h("div", { slot: "actions" }, h("eds-button", { outlined: true, size: "md", iconPosition: "right", content: "Connect new Customer ID" }, h("eds-icon", { slot: "icon", icon: "plus" })))),
      h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-elevation", { level: "5" }, h("eds-card", { "no-border": true }, h("div", { slot: "card-content" }, h("div", null, h("eds-heading", { type: "h5", fontWeight: "bold", "margin-bottom-2": true, content: "Account information", styles: "secondary" }), this.blockData.map(data => h("eds-app-data-block", { onClickDataBlock: e => this.clickDataBlockHander(e), data: data })), h("div", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.BUTTONS}` }, h("eds-button", { outlined: true, size: "md", content: "Disable this account" }))))))), h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-6": true, "lg-6": true, "xlg-6": true }, h("eds-elevation", { level: "5" }, h("eds-card", { "no-border": true }, h("div", { slot: "card-content" }, h("eds-card", { styles: this.brand || 'primary' }, h("div", { slot: "card-content" }, h("div", { class: `${this.classNames.EL}${this.classNames.CARD}${this.classNames.BILLING}` }, h("eds-heading", { type: "h6", fontWeight: "bold", "margin-bottom-2": true, content: "This address is used for your billing only", styles: "secondary" }), h("eds-paragraph", { type: "body-2", "margin-bottom-2": true, content: "Changing this address does not mean that we will move your contract.<br />If you want to change where contract will be used, please click the button below.", styles: "secondary-500" }), h("eds-button", { outlined: true, size: "md", content: "I'm moving" })))), h("div", null, h("eds-heading", { type: "h5", fontWeight: "bold", "margin-top-2": true, "margin-bottom-2": true, content: "Billing data", styles: "secondary" }), this.blockData2.map(data => h("eds-app-data-block", { onClickDataBlock: e => this.clickDataBlockHander(e), data: data })))))))),
      h("eds-dialog", { class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CHANGE_PASSWORD}`, columns: 6 }, h("div", { slot: "dialog-header" }, h("div", { class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.HEADER}` }, h("eds-heading", { type: "h5", "font-weight": "bold", styles: "left secondary-500", content: "Please check your email" }), h("eds-button", { size: "sm", textOnly: true, styles: "secondary", onClickButton: () => this.closeDialog(`.${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CHANGE_PASSWORD}`) }, h("eds-icon", { slot: "icon", icon: "times" })))), h("div", { slot: "dialog-body" }, h("eds-paragraph", { type: "body-1", styles: "left secondary-500" }, "You should receive link to reset your password on your email address gilles.hermes@enovos.lu. For further steps, follow email instructions.")), h("div", { slot: "dialog-footer" }, h("div", { class: `${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.FOOTER}` }, h("eds-button", { content: "Done", onClickButton: () => this.closeDialog(`.${this.classNames.EL}${this.classNames.DIALOG}${this.classNames.CHANGE_PASSWORD}`), styles: "primary" })))),
    ];
  }
  get el() { return getElement(this); }
...
const ENOVOSViewAppEnovosSectionOverview = class {
  ...
  render() {
    return [
      h("eds-panel", { headerTitle: "Consumption" }, h("div", { slot: "header-actions" }, h("eds-button", { content: "More details", "icon-position": "right", outlined: true, size: "sm", styles: "secondary", onClickButton: () => {
          this.addChartData();
        } }, h("eds-icon", { slot: "icon", icon: "chevron-right" }))), h("div", { slot: "body-content" }, h("eds-line-chart", { id: "chart", height: 250, "min-width": 800 }))),
      h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-8": true, "xlg-8": true, "margin-top-4": true }, h("eds-panel", { fullHeight: true, headerTitle: "Latest invoices", headerNoMinHeight: true, headerPaddingBottom: "0" }, h("div", { slot: "header-actions" }, h("eds-button", { content: "See all", "icon-position": "right", outlined: true, size: "sm", styles: "secondary" }, h("eds-icon", { slot: "icon", icon: "chevron-right" }))), h("div", { slot: "body-content" }, h("eds-data-table", { "hidden-xxs": true, "hidden-xs": true, "hidden-sm": true, id: "latest-invoices-data-table" }), h("eds-mobile-data-table", { "hidden-md": true, "hidden-lg": true, "hidden-xlg": true, id: "latest-invoices-mobile-data-table" })))), h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-8": true, "md-12": true, "lg-4": true, "xlg-4": true, "margin-top-4": true, alignContent: "right" }, h("eds-panel", { fullHeight: true, headerTitle: "Quick actions", headerNoMinHeight: true, headerPaddingBottom: "0" }, h("div", { slot: "body-content" }, this.quickActions.map(item => h("eds-quick-action", { id: item.id, onClickItem: (e) => alert(`onClickItem: ${e.detail}`), styles: this.brand, icon: item.icon, "main-title": item.title, subtitle: item.subtitle, "show-trailing-icon": true })))))),
    ];
  }
  get el() { return getElement(this); }
};
...
const ENOVOSViewAppEnovosSectionOverviewWithSlider = class {
  ...
  render() {
    return [
      h("eds-panel", { headerTitle: "Consumption", "margin-bottom-4": true, "header-padding-bottom": "0", "header-no-min-height": true }, h("div", { slot: "header-actions" }, h("eds-button", { disabled: this.isSliderBeginning, outlined: true, size: "sm", styles: "secondary", onClickButton: this.slidePrev }, h("eds-icon", { slot: "icon", icon: "chevron-left" })), h("eds-button", { disabled: this.isSliderEnd, outlined: true, size: "sm", styles: "secondary", onClickButton: this.slideNext }, h("eds-icon", { slot: "icon", icon: "chevron-right" }))), h("div", { slot: "body-content" }, h("eds-slider", { id: "bar-chart-slider", onSlideChange: this.onSlideChange }))),
      h("eds-grid-layout", null, h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-8": true, "lg-8": true, "xlg-8": true }, h("eds-panel", { fullHeight: true, headerTitle: "Latest invoices", headerNoMinHeight: true, headerPaddingBottom: "0" }, h("div", { slot: "header-actions" }, h("eds-button", { content: "See all", "icon-position": "right", outlined: true, size: "sm", styles: "secondary" }, h("eds-icon", { slot: "icon", icon: "chevron-right" }))), h("div", { slot: "body-content" }, h("eds-data-table", { id: "latest-invoices-data-table" })))), h("eds-grid-layout-item", { "xxs-4": true, "xs-4": true, "sm-4": true, "md-4": true, "lg-4": true, "xlg-4": true, alignContent: "right" }, h("eds-panel", { fullHeight: true, headerTitle: "Quick actions", headerNoMinHeight: true, headerPaddingBottom: "0" }, h("div", { slot: "body-content" }, this.quickActions.map(item => h("eds-quick-action", { id: item.id, onClickItem: (e) => alert(`onClickItem: ${e.detail}`), styles: this.brand, icon: item.icon, "main-title": item.title, subtitle: item.subtitle, "show-trailing-icon": true })))))),
    ];
  }
  get el() { return getElement(this); }
};
...
export { ENOVOSAppDialogContracts as eds_app_dialog_contracts, ENOVOSAppHeader as eds_app_header, ENOVOSGridStyleTwo as eds_grid_style_two, ENOVOSViewAppEnovosSection404 as eds_view_app_enovos_section_404, ENOVOSViewAppEnovosSectionConsumption as eds_view_app_enovos_section_consumption, ENOVOSViewAppEnovosSectionContractDetails as eds_view_app_enovos_section_contract_details, ENOVOSViewAppEnovosSectionContractList as eds_view_app_enovos_section_contract_list, ENOVOSViewAppEnovosSectionContractListEmpty as eds_view_app_enovos_section_contract_list_empty, ENOVOSViewAppEnovosSectionIAmMovingSingleContract as eds_view_app_enovos_section_i_am_moving_single_contract, ENOVOSViewAppEnovosSectionInvoices as eds_view_app_enovos_section_invoices, ENOVOSViewAppEnovosSectionLandingPage as eds_view_app_enovos_section_landing_page, ENOVOSViewAppEnovosSectionMyAccountMultiple as eds_view_app_enovos_section_my_account_multiple, ENOVOSViewAppEnovosSectionMyAccountSingle as eds_view_app_enovos_section_my_account_single, ENOVOSViewAppEnovosSectionOverview as eds_view_app_enovos_section_overview, ENOVOSViewAppEnovosSectionOverviewWithSlider as eds_view_app_enovos_section_overview_with_slider };
