...
const ENOVOSSideSheet = class {
  ...
  /** REMOVABLE START */
  render() {
    return (h("eds-elevation", { styles: this.elevationStyle, level: this.elevationLevel, class: this.classNames.EL }, h("div", { class: `${this.classNames.EL}${this.classNames.WRAPPER}` }, h("div", { class: `${this.classNames.EL}${this.classNames.CONTENT}` }, h("slot", null)))));
  }
  get el() { return getElement(this); }
};
ENOVOSSideSheet.style = sideSheetCss;

export { ENOVOSSideSheet as eds_side_sheet };
