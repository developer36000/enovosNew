...
const ENOVOSFieldsGroup = class {
  ...
  render() {
    return (h("fieldset", { class: this.classNames.EL }, (this.mainTitle || this.tooltipContent) &&
      h("div", { class: `${this.classNames.EL}__title` }, h("div", { class: `${this.classNames.EL}__title-text` }, h("eds-heading", { content: this.mainTitle, type: "h6", "font-weight": "bold", styles: "secondary" })), this.tooltipContent &&
        h("div", { class: `${this.classNames.EL}__tooltip` }, h("eds-icon", { id: this.uniqueId, icon: "question-circle", styles: "secondary-300", size: "x3" }), h("eds-tooltip", { selector: this.uniqueId, text: this.tooltipContent }))), h("div", { class: `${this.classNames.EL}__content` }, h("slot", null))));
  }
...
const ENOVOSPricingTable = class {
  ...
  render() {
    return (h("div", { class: this.getComponentClassName() }, this.items && this.items.map((item) => {
      var _a, _b, _c;
      return h("div", { key: item.id, class: this.getItemClassName(item) }, this.recommendedItem && this.recommendedItem === item.id &&
        h("div", { class: `${this.classNames.EL}__badge` }, h("eds-heading", { type: "h6", "font-weight": "bold", styles: "white", content: ((_a = this.locale) === null || _a === void 0 ? void 0 : _a.recommended) || 'Recommended' })), h("div", { class: `${this.classNames.EL}__header` }, h("eds-heading", { styles: "secondary", type: "h5", content: item.title, "font-weight": "bold" }), h("eds-heading", { styles: "secondary", type: "h6", content: item.subtitle })), h("div", { class: `${this.classNames.EL}__description` }, item.description.map((descriptionItem) => h("eds-paragraph", { "margin-top-1": true, "margin-bottom-1": true, type: "body-1" }, descriptionItem))), h("div", { class: `${this.classNames.EL}__prices` }, h("div", { class: `${this.classNames.EL}__price` }, h("eds-heading", { type: "h4", styles: "secondary", content: `<span class="${this.classNames.EL}__currency">€ </span>${item.monthlyPrice}*`, "font-weight": "bold" }), h("div", { class: `${this.classNames.EL}__price-suffix` }, h("eds-heading", { styles: "secondary", type: "h6", content: ((_b = this.locale) === null || _b === void 0 ? void 0 : _b.perMonth) || 'per month' }))), h("div", { class: `${this.classNames.EL}__price` }, h("eds-heading", { type: "h5", styles: "secondary", content: `<span class="${this.classNames.EL}__currency">€ </span>${item.yearlyPrice}*`, "font-weight": "bold" }), h("div", { class: `${this.classNames.EL}__price-suffix` }, h("eds-heading", { styles: "secondary", type: "h6", content: ((_c = this.locale) === null || _c === void 0 ? void 0 : _c.perYear) || 'per year' })))), h("div", { class: `${this.classNames.EL}__checkbox` }, h("eds-radio-button", { selected: this.selectedItem && this.selectedItem === item.id, styles: this.styles, onClickRadioButton: () => {
...
const ENOVOSSteps = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.clickStep = createEvent(this, "clickStep", 7);
    this.styles = 'primary';
  ...
  render() {
    return (h("ol", { class: this.getComponentClassName() }, this.items && this.items.length > 0 && this.items.map((item, index) => h("li", { class: this.getItemClassName(item), key: item.id, onClick: () => this.onClickItem(item.id) }, h("span", { class: this.classNames.EL + this.classNames.ICON }, item.isValid
      ?
        h("span", { class: this.classNames.EL + this.classNames.ICON_TEXT }, h("eds-icon", { icon: "check", styles: "white" }))
      : h("span", { class: this.classNames.EL + this.classNames.ICON_TEXT }, index + 1)), h("span", { class: this.classNames.EL + this.classNames.TITLE }, h("eds-paragraph", { type: "body-1", "font-weight": "bold", styles: "secondary-500" }, item.title))))));
  }
  get el() { return getElement(this); }
};
...
const ENOVOSUploadDragger = class {
  ...
  render() {
    return (h("div", { class: this.getComponentClassName(), style: this.getStyleAttributeValue() }, h("div", { class: `${this.classNames.EL}__icon` }, h("eds-icon", { icon: "plus", styles: this.styles })), h("div", { class: `${this.classNames.EL}__content` }, h("slot", { name: "text" }))));
  }
  get el() { return getElement(this); }
};
...
const ENOVOSUploadedImage = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.clickView = createEvent(this, "clickView", 7);
    this.clickRemove = createEvent(this, "clickRemove", 7);
  ...
  render() {
    return (h("div", { class: this.getComponentClassName(), style: this.getStyleAttributeValue() }, h("div", { class: `${this.classNames.EL}__image` }, h("img", { src: this.imageSrc, alt: "" })), this.variation === 'list-item' ?
      h("div", { class: `${this.classNames.EL}__file-info` }, this.fileName &&
        h("eds-paragraph", { type: "body-2", styles: "secondary" }, this.fileName), this.fileSize &&
        h("eds-paragraph", { type: "body-3", styles: "secondary" }, this.fileSize))
      :
        !this.overlayDisabled && (h("div", { class: `${this.classNames.EL}__overlay` }, h("div", { class: `${this.classNames.EL}__actions` }, h("div", { class: `${this.classNames.EL}__action` }, h("eds-button", { "text-only": true, styles: "white", size: "sm", onClickButton: this.handleClickView }, h("eds-icon", { slot: "icon", icon: "search", styles: "white", size: "2" }))), h("div", { class: `${this.classNames.EL}__action` }, h("eds-button", { "text-only": true, styles: "white", size: "sm", onClickButton: this.handleClickRemove }, h("eds-icon", { slot: "icon", icon: "trash-alt", styles: "white", size: "2" })))), h("div", { class: `${this.classNames.EL}__file-info` }, this.fileName &&
          h("eds-paragraph", { type: "body-2", styles: "white" }, this.fileName), this.fileSize &&
...
export { ENOVOSFieldsGroup as eds_fields_group, ENOVOSPricingTable as eds_pricing_table, ENOVOSSteps as eds_steps, ENOVOSUploadDragger as eds_upload_dragger, ENOVOSUploadedImage as eds_uploaded_image };
