...
const ENOVOSViewAppEnovosView = class {
  ...
  render() {
    return [
      ...
      })()), h("footer", { slot: "footer-area", class: `${this.classNames.EL}${this.classNames.FOOTER}` }, h("div", { class: `${this.classNames.EL}${this.classNames.FOOTER}-left` }, h("eds-paragraph", { type: "body-1" }, "\u00A92021 Enovos - All right reserved")), h("div", { class: `${this.classNames.EL}${this.classNames.FOOTER}-right` }, h("eds-link", { class: `${this.classNames.EL}${this.classNames.FOOTER}${this.classNames.LINK}`, content: "Enovos.lu" }), h("eds-link", { class: `${this.classNames.EL}${this.classNames.FOOTER}${this.classNames.LINK}`, content: "Contact" }), h("eds-link", { class: `${this.classNames.EL}${this.classNames.FOOTER}${this.classNames.LINK}`, content: "About us" }), h("eds-link", { class: `${this.classNames.EL}${this.classNames.FOOTER}${this.classNames.LINK}`, content: "Privacy policy" }), h("eds-link", { class: `${this.classNames.EL}${this.classNames.FOOTER}${this.classNames.LINK}`, content: "Terms and conditions" })))),
...
export { ENOVOSViewAppEnovosView as eds_view_app_enovos };
