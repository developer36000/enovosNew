...
const ENOVOSBottomSheet = class {
  ...
  render() {
    return [
      ...
      h("div", { class: `${this.classNames.EL}${this.classNames.WRAPPER}` }, this.hasHeaderSlot
        ? h("slot", { name: `${this.classNames.EL}${this.classNames.HEADER}` })
        : '', h("div", { class: `${this.classNames.EL}${this.classNames.CONTENT}` }, h("slot", null), this.hasFooterSlot
...
export { ENOVOSBottomSheet as eds_bottom_sheet };
