...
const ENOVOSProgressBar = class {
  ...
  render() {
    return (index.h("div", { class: [
      ...
      ? index.h("eds-paragraph", { class: `${this.classNames.EL}${this.classNames.TITLE}`, type: "body-1", styles: (this.light) ? 'white' : 'secondary-500', "font-weight": "semi-bold", innerHTML: this.titleText })
      : '', this.graduated === true
      ? index.h("div", { class: `${this.classNames.EL}${this.classNames.GRADUATE}` }, this.getGraduateItems().map(graduatedItem => index.h("span", { class: [
      ...
      : index.h("div", { class: `${this.classNames.EL}${this.classNames.BAR}` }, index.h("span", { class: `${this.classNames.EL}${this.classNames.VALUE}` })), this.leadingText || this.trailingText
      ? index.h("div", { class: `${this.classNames.EL}${this.classNames.BOTTOM}` }, this.leadingText
        ? index.h("eds-paragraph", { class: `${this.classNames.EL}${this.classNames.BOTTOM}${this.classNames.LEFT}`, type: "body-3", styles: (this.light) ? 'white' : 'tertiary-500', innerHTML: this.leadingText })
        : '', this.trailingText
        ? index.h("eds-paragraph", { class: `${this.classNames.EL}${this.classNames.BOTTOM}${this.classNames.RIGHT}`, type: "body-3", styles: (this.light) ? 'white' : 'tertiary-500', innerHTML: this.trailingText })
        : '')
      : ''));
  }
...
exports.eds_progress_bar = ENOVOSProgressBar;
