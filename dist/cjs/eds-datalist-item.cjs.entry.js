...
const ENOVOSDatalistItem = class {
  constructor(hostRef) {
    ...
    this.clickDatalistItem = index.createEvent(this, "clickDatalistItem", 7);
  ...
  async setDatalistItem(item) {
    const dataItem = new DatalistItemPropsHelper.DatalistItem(item);
    this.item = dataItem;
    ...
    this.parameters = new DatalistItemPropsHelper.DatalistItemData(this.item.getProp('data'));
  ...
  componentDidUpdate() {
    if (!this.eventInit) {
      ...
      if (itemEl) {
        ...
        this._clickItemHandler = new tapEvent.TapEvent(itemEl, () => {
  ...
  oneColumnTemplate() {
    return [
      index.h("section", { class: `${this.classNames.EL}${this.classNames.MAIN}` }, this.getAliasTemplate('main')),
    ];
  }
  /**
   * @description Generate a 2 columns template
  ...
  twoColumnsTemplate() {
    return [
      index.h("section", { class: `${this.classNames.EL}${this.classNames.LEFT}` }, this.getAliasTemplate('left')),
      index.h("section", { class: `${this.classNames.EL}${this.classNames.RIGHT}` }, this.getAliasTemplate('right')),
    ];
  }
  /**
  ...
  threeColumnsTemplate() {
    return [
      index.h("section", { class: `${this.classNames.EL}${this.classNames.FIRST}` }, this.getAliasTemplate('first')),
      index.h("section", { class: `${this.classNames.EL}${this.classNames.SECOND}` }, this.getAliasTemplate('second')),
      index.h("section", { class: `${this.classNames.EL}${this.classNames.THIRD}` }, this.getAliasTemplate('third')),
    ];
  }
  tableTemplate() {
    if (Array.isArray(Object.values(this.parameters))) {
      return Object.values(this.parameters).map((parameter, index$1) => {
        const parameterObject = new DatalistItemPropsHelper.DatalistItemData(parameter);
        return index.h("div", { "data-columns": Object.values(this.parameters).length }, this.renderColumn(parameterObject, 'table', `${this.classNames.EL}${this.classNames.COLUMN}`, index$1));
      });
    }
    return '';
  }
  ...
  renderDefault2ColumnsLeft(objectPropriety) {
    const badge = _hasPath.get(this.mapping, `${objectPropriety}.badge`);
    const icon = _hasPath.get(this.mapping, `${objectPropriety}.icon`);
    const image = _hasPath.get(this.mapping, `${objectPropriety}.image`);
    const button = _hasPath.get(this.mapping, `${objectPropriety}.button`);
    const header = _hasPath.get(this.mapping, `${objectPropriety}.header`);
    const text = _hasPath.get(this.mapping, `${objectPropriety}.text`);
    const body = _hasPath.get(this.mapping, `${objectPropriety}.body`);
    const bodyAdditional = _hasPath.get(this.mapping, `${objectPropriety}.body-additional`);
    const footer = _hasPath.get(this.mapping, `${objectPropriety}.footer`);
    const radio = _hasPath.get(this.mapping, `${objectPropriety}.radio`);
    ...
    return [
      ...
      this.parameters.hasProp(radio)
        ? index.h("eds-radio-button", { inputName: this.parameters.getProp(`${radio}.name`), value: this.parameters.getProp(`${radio}.value`), icon: this.parameters.getProp(`${radio}.icon`), selected: this.parameters.getProp(`${radio}.selected`), class: [
      ...
      this.parameters.hasProp(badge)
        ? index.h("eds-badge", { size: this.getItemSize(this.parameters, badge), styles: this.parameters.getProp(`${badge}.styles`), text: this.parameters.getProp(`${badge}.text`), class: `${this.classNames.EL}${this.classNames.BADGE}` })
        : '',
      this.parameters.hasProp(icon)
        ? index.h("eds-icon", { size: this.getItemSize(this.parameters, icon), styles: this.parameters.getProp(`${icon}.styles`), icon: this.parameters.getProp(`${icon}.icon`), class: `${this.classNames.EL}${this.classNames.ICON}` })
        : '',
      this.parameters.hasProp(image)
        ? index.h("eds-image", { class: `${this.classNames.EL}${this.classNames.IMAGE}`, src: this.parameters.getProp(image) })
        : '',
      index.h("div", { class: `${this.classNames.EL}${this.classNames.BODY}` }, this.parameters.hasProp(header)
        ? index.h("eds-paragraph", { type: this.parameters.hasProp(`${header}.type`) ? this.parameters.getProp(`${header}.type`) : 'body-2', fontWeight: this.parameters.hasProp(`${header}.fontWeight`) ? this.parameters.getProp(`${header}.fontWeight`) : 'regular', styles: [
            'line-height-body-2',
        ...
        ? index.h("eds-paragraph", { type: this.parameters.hasProp(`${body}.type`) ? this.parameters.getProp(`${body}.type`) : 'body-2', styles: [
            'line-height-body-2',
          ...
          ? [
            index.h("span", null, " - "),
            index.h("span", { class: `${this.classNames.EL}${this.classNames.BODY_LEFT_ADDITIONAL}` }, this.parameters.getProp(bodyAdditional)),
          ]
          : '')
        : '', this.parameters.hasProp(text)
        ? index.h("eds-paragraph", { clampLines: this.parameters.hasProp(`${text}.clampLines`) ? this.parameters.getProp(`${text}.clampLines`) : 0, fontWeight: this.parameters.hasProp(`${text}.fontWeight`) ? this.parameters.getProp(`${text}.fontWeight`) : 'regular', type: this.parameters.hasProp(`${text}.type`) ? this.parameters.getProp(`${text}.type`) : 'body-1', styles: [
      ...
      this.parameters.hasProp(button)
        ? index.h("eds-button", { styles: this.parameters.getProp(`${button}.styles`), id: this.parameters.getProp(`${button}.id`), content: this.parameters.getProp(`${button}.content`), size: this.parameters.getProp(`${button}.size`), outlined: this.parameters.getProp(`${button}.outlined`), "text-only": this.parameters.getProp(`${button}.text-only`), class: `${this.classNames.EL}${this.classNames.BUTTON}` })
        : '',
    ];
  }
  /**
  ...
  renderDefault2ColumnsRight(objectPropriety) {
    ...
    const footer = _hasPath.get(this.mapping, `${objectPropriety}.footer`);
    const text = _hasPath.get(this.mapping, `${objectPropriety}.text`);
    const link = _hasPath.get(this.mapping, `${objectPropriety}.link`);
    const icon = _hasPath.get(this.mapping, `${objectPropriety}.icon`);
    const button = _hasPath.get(this.mapping, `${objectPropriety}.button`);
    const radio = _hasPath.get(this.mapping, `${objectPropriety}.radio`);
    const menuDropdown = _hasPath.get(this.mapping, `${objectPropriety}.menu-dropdown`);
    const tags = _hasPath.get(this.mapping, `${objectPropriety}.tags`);
    if (this.parameters === undefined) {
      return;
    }
    return [
      index.h("div", { class: `${this.classNames.EL}${this.classNames.BODY}` }, this.setCollapseIcon(this.item, 'trailing'), this.parameters.hasProp(header)
        ? index.h("eds-small", { styles: [
            'uppercase',
            'line-height-body-2',
            this.parameters.hasProp(`${header}.styles`) ? this.parameters.getProp(`${header}.styles`) : this.getAdditionalStyles(this.parameters, header),
        ...
        : '', this.parameters.hasProp(body)
        ? index.h("eds-heading", { type: "h6", "font-weight": "semi-bold", styles: [
            'line-height-body-2',
            this.parameters.hasProp(`${body}.styles`) ? this.parameters.getProp(`${body}.styles`) : this.getAdditionalStyles(this.parameters, body),
        ...
        : '', this.parameters.hasProp(text)
        ? index.h("eds-paragraph", { clampLines: this.parameters.hasProp(`${text}.clampLines`) ? this.parameters.getProp(`${text}.clampLines`) : 0, type: this.parameters.hasProp(`${text}.type`) ? this.parameters.getProp(`${text}.type`) : 'body-1', fontWeight: this.parameters.hasProp(`${text}.fontWeight`) ? this.parameters.getProp(`${text}.fontWeight`) : 'semi-bold', styles: [
            this.parameters.hasProp(`${text}.styles`) ? this.parameters.getProp(`${text}.styles`) : this.getAdditionalStyles(this.parameters, text),
        ...
        ? index.h("eds-link", { id: this.parameters.hasProp(`${link}.id`) ? this.parameters.getProp(`${link}.id`) : undefined, size: this.parameters.hasProp(`${link}.size`) ? this.parameters.getProp(`${link}.size`) : undefined, url: this.parameters.hasProp(`${link}.url`) ? this.parameters.getProp(`${link}.url`) : '#', mailto: this.parameters.hasProp(`${link}.mailto`) ? this.parameters.getProp(`${link}.mailto`) : undefined, content: this.parameters.hasProp(`${link}.content`) ? this.parameters.getProp(`${link}.content`) : '', iconPosition: this.parameters.hasProp(`${link}.iconPosition`) ? this.parameters.getProp(`${link}.iconPosition`) : undefined, styles: this.parameters.hasProp(`${link}.styles`) ? this.parameters.getProp(`${link}.styles`) : '', underline: this.parameters.hasProp(`${link}.underline`) ? this.parameters.getProp(`${link}.underline`) : false, target: this.parameters.hasProp(`${link}.target`) ? this.parameters.getProp(`${link}.target`) : '_self', class: `${this.classNames.EL}${this.classNames.BODY_RIGHT}` })
        : '', this.parameters.hasProp(footer)
        ? index.h("eds-paragraph", { clampLines: this.parameters.hasProp(`${footer}.clampLines`) ? this.parameters.getProp(`${footer}.clampLines`) : 0, fontWeight: this.parameters.hasProp(`${footer}.fontWeight`) ? this.parameters.getProp(`${footer}.fontWeight`) : 'regular', type: this.parameters.hasProp(`${footer}.type`) ? this.parameters.getProp(`${footer}.type`) : 'body-2', styles: [
            'line-height-body-2',
            this.parameters.hasProp(`${footer}.styles`) ? this.parameters.getProp(`${footer}.styles`) : this.getAdditionalStyles(this.parameters, footer),
        ...
        : '', this.parameters.hasProp(button)
        ? index.h("eds-button", { styles: this.parameters.getProp(`${button}.styles`), size: this.parameters.getProp(`${button}.size`), outlined: this.parameters.getProp(`${button}.outlined`), "text-only": this.parameters.getProp(`${button}.text-only`), class: `${this.classNames.EL}${this.classNames.BUTTON}` }, index.h("eds-icon", { slot: "icon", icon: this.parameters.getProp(`${button}.icon`) }))
        : '', this.parameters.hasProp(icon)
        ? index.h("eds-icon", { styles: this.parameters.getProp(`${icon}.styles`), icon: this.parameters.getProp(`${icon}.icon`), size: this.parameters.getProp(`${icon}.size`), class: `${this.classNames.EL}${this.classNames.BUTTON}` })
        : ''),
      this.parameters.hasProp(tags) && this.parameters.getProp(tags).length > 0
        ? index.h("div", { class: [
          ...
          return index.h("div", { class: `${this.classNames.EL}${this.classNames.TAGS}${this.classNames.TAG}` }, index.h("eds-icon", { styles: _hasPath.get(tag, `icon.styles`), icon: _hasPath.get(tag, `icon.icon`), size: _hasPath.get(tag, `icon.size`), class: `${this.classNames.EL}${this.classNames.TAGS}${this.classNames.TAG}${this.classNames.ICON}` }), this.getTypoComponent(this.parameters, tag));
        }))
        : '',
      this.parameters.hasProp(radio)
        ? index.h("eds-radio-button", { inputName: this.parameters.getProp(`${radio}.name`), value: this.parameters.getProp(`${radio}.value`), icon: this.parameters.getProp(`${radio}.icon`), selected: this.parameters.getProp(`${radio}.selected`), class: [
      ...
      this.parameters.hasProp(menuDropdown)
        ? index.h("eds-dropdown", { "align-right": true, class: `${this.classNames.EL}${this.classNames.DROPDOWN}`, data: this.parameters.getProp(`${menuDropdown}.data`) }, index.h("div", { slot: "selector" }, index.h("eds-icon", { slot: "icon", class: `${this.classNames.EL}${this.classNames.DROPDOWN}${this.classNames.ICON}`, styles: this.parameters.getProp(`${menuDropdown}.styles`), size: this.parameters.getProp(`${menuDropdown}.size`), icon: this.parameters.getProp(`${menuDropdown}.icon`) })))
        : '',
    ];
  }
  getTypoComponent(parameters, item, itemClass = '', styles = []) {
    return (() => {
      switch (parameters.getProp(`${item}.type`)) {
        ...
        case 'h5':
        case 'h6':
          return index.h("eds-heading", { type: parameters.hasProp(`${item}.type`) ? parameters.getProp(`${item}.type`) : 'h6', fontWeight: parameters.hasProp(`${item}.fontWeight`) ? parameters.getProp(`${item}.fontWeight`) : 'semi-bold', styles: concat.concat(parameters.hasProp(`${item}.styles`) ? parameters.getProp(`${item}.styles`) : '', styles).join(' '), class: itemClass, content: parameters.hasProp(`${item}.content`) ? parameters.getProp(`${item}.content`) : parameters.getProp(item) });
        default:
        case 'body-1':
        case 'body-2':
        case 'body-3':
          return index.h("eds-paragraph", { type: parameters.hasProp(`${item}.type`) ? parameters.getProp(`${item}.type`) : 'body-2', styles: concat.concat(parameters.hasProp(`${item}.styles`) ? parameters.getProp(`${item}.styles`) : '', styles).join(' '), clampLines: parameters.hasProp(`${item}.clampLines`) ? parameters.getProp(`${item}.clampLines`) : 2, fontWeight: parameters.hasProp(`${item}.fontWeight`) ? parameters.getProp(`${item}.fontWeight`) : '', class: itemClass, content: parameters.hasProp(`${item}.content`) ? parameters.getProp(`${item}.content`) : parameters.getProp(item) });
        case 'small':
          return index.h("eds-small", { styles: concat.concat(parameters.hasProp(`${item}.styles`) ? parameters.getProp(`${item}.styles`) : '', styles).join(' '), fontWeight: parameters.hasProp(`${item}.fontWeight`) ? parameters.getProp(`${item}.fontWeight`) : 'regular', content: parameters.hasProp(`${item}.content`) ? parameters.getProp(`${item}.content`) : parameters.getProp(item), class: itemClass });
      }
    })();
  }
  renderColumn(parameters, objectPropriety, columnClass, indexColumn) {
    ...
    const badge = _hasPath.get(this.mapping, `${objectPropriety}.badge`);
    const header = _hasPath.get(this.mapping, `${objectPropriety}.header`);
    const headerAdditional = _hasPath.get(this.mapping, `${objectPropriety}.header-additional`);
    const icon = _hasPath.get(this.mapping, `${objectPropriety}.icon`);
    const body = _hasPath.get(this.mapping, `${objectPropriety}.body`);
    const bodyAdditional = _hasPath.get(this.mapping, `${objectPropriety}.body-additional`);
    const date = _hasPath.get(this.mapping, `${objectPropriety}.date`);
    const footer = _hasPath.get(this.mapping, `${objectPropriety}.footer`);
    const tags = _hasPath.get(this.mapping, `${objectPropriety}.tags`);
    return [
      parameters.hasProp(image)
        ? index.h("eds-image", { class: `${this.classNames.EL}${this.classNames.IMAGE}`, src: parameters.getProp(image) })
        : '',
      index.h("div", { class: `${this.classNames.EL}${this.classNames.BODY}` }, parameters.hasProp(header)
        ? index.h("div", { class: `${columnClass}${this.classNames.HEADER}` }, parameters.hasProp(badge)
          ? index.h("eds-badge", { size: parameters.hasProp(`${badge}.size`) ? this.getItemSize(parameters, badge) : 'xxs', styles: parameters.hasProp(`${badge}.styles`) ? parameters.getProp(`${badge}.styles`) : 'success', text: parameters.getProp(`${badge}.text`), class: `${columnClass}${this.classNames.HEADER}${this.classNames.BADGE}` })
        ...
        ? index.h("div", { class: `${columnClass}${this.classNames.BODY}` }, parameters.hasProp(icon)
          ? index.h("eds-icon", { size: parameters.hasProp(`${icon}.size`) ? this.getItemSize(parameters, icon) : '2x', styles: parameters.hasProp(`${icon}.styles`) ? parameters.getProp(`${icon}.styles`) : 'tertiary-500', icon: parameters.getProp(`${icon}.icon`), class: `${columnClass}${this.classNames.BODY}${this.classNames.ICON}` })
          : '', index.h("div", { class: [
  ...
  hasCollapseIcon(item, position) {
    return (this.isAccordionConfig(item) === true || this.isCollapsedConfig(item) === true)
      && has.has(this.collapsedConfig, `icons.${position}`);
  }
  setCollapseIcon(item, position) {
    return this.hasCollapseIcon(item, position)
      ? index.h("eds-icon", { slot: "icon", class: [
          ...
          has.has(this.collapsedConfig, `icons.${position}.default.style`) ? _hasPath.get(this.collapsedConfig, `icons.${position}.default.style`) : ''
          :
            has.has(this.collapsedConfig, `icons.${position}.active.style`) ? _hasPath.get(this.collapsedConfig, `icons.${position}.active.style`) : '', icon: (!this.collapsed) ?
          has.has(this.collapsedConfig, `icons.${position}.default.icon`) ? _hasPath.get(this.collapsedConfig, `icons.${position}.default.icon`) : 'chevron-down'
          :
            has.has(this.collapsedConfig, `icons.${position}.active.icon`) ? _hasPath.get(this.collapsedConfig, `icons.${position}.active.icon`) : 'chevron-up' })
      : '';
  }
  ...
  getAdditionalStyles(parameters, propriety = '') {
    return _hasPath.get(parameters, `styles${(propriety !== '' ? `.${propriety}` : '')}`);
  }
  getLineStyles() {
    const classes = [];
    ...
    if (this.item) {
      return [
        index.h("div", { class: [
          ...
          ].join(' ') }, index.h("div", { class: `${this.classNames.EL}${this.classNames.WRAPPER}` }, (() => {
        ...
        })()), has.has(this.parameters, 'progress-bar')
          ? index.h("eds-progress-bar", { progressMax: parseInt(this.parameters.getProp('progress-bar.progress-max'), 10), progressValue: parseInt(this.parameters.getProp('progress-bar.progress-value'), 10), "leading-text": this.parameters.getProp('progress-bar.leading-text'), "trailing-text": this.parameters.getProp('progress-bar.trailing-text'), class: `${this.classNames.EL}${this.classNames.PROGRESS_BAR}` })
          : '', has.has(this.parameters, 'message')
          ? index.h("eds-message", { class: `${this.classNames.EL}${this.classNames.MESSAGE}`, "icon-leading": this.parameters.getProp('message.icon-leading'), styles: this.parameters.getProp('message.styles') }, this.parameters.getProp('message.text'))
          : ''),
        index.h("div", { class: "slot-content-container" }, index.h("slot", { name: "content" })),
      ];
    }
...
exports.eds_datalist_item = ENOVOSDatalistItem;
