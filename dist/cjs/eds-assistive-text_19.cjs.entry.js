...
const toNumber = require('./toNumber-e6ce1248.js');
...
const set$1 = require('./set-82454825.js');
require('./_arrayEach-c0f7fc70.js');
require('./_baseFindIndex-4f56dd76.js');
const _hasPath$1 = require('./_hasPath-fb5594fa.js');
...
function charsEndIndex(strSymbols, chrSymbols) {
  ...
  while (index-- && uniq.baseIndexOf(chrSymbols, strSymbols[index], 0) > -1) {}
  return index;
}
...
function charsStartIndex(strSymbols, chrSymbols) {
  ...
  while (++index < length && uniq.baseIndexOf(chrSymbols, strSymbols[index], 0) > -1) {}
  return index;
}
...
function trim(string, chars, guard) {
  ...
  if (string && (guard || chars === undefined)) {
    return toNumber.baseTrim(string);
  }
  if (!string || !(chars = toString$1.baseToString(chars))) {
    return string;
  }
  var strSymbols = _stringToArray.stringToArray(string),
      chrSymbols = _stringToArray.stringToArray(chars),
      start = charsStartIndex(strSymbols, chrSymbols),
      end = charsEndIndex(strSymbols, chrSymbols) + 1;

  return _stringToArray.castSlice(strSymbols, start, end).join('');
}
...
function uniqBy(array, iteratee) {
  return (array && array.length) ? uniq.baseUniq(array, _baseIteratee.baseIteratee(iteratee)) : [];
}
...
const ENOVOSAvatar = class {
  ...
  /** REMOVABLE START */
  render() {
    return (index.h("eds-elevation", { styles: this.elevationStyle, level: this.elevationLevel, class: [
        this.classNames.EL,
        this.getSize(),
      ].join(' ') }, this.src && !isEmpty.isEmpty(trim(this.src))
      ? index.h("eds-image", { class: `${this.classNames.EL}${this.classNames.IMG}`, src: this.src })
      : index.h("div", { class: `${this.classNames.EL}${this.classNames.CONTAINER}` }, index.h("eds-icon", { icon: this.icon, styles: this.iconStyle, class: `${this.classNames.EL}${this.classNames.CONTAINER}${this.classNames.ICON}` }))));
  }
  get el() { return index.getElement(this); }
};
...
const ENOVOSBadge = class {
  ...
  /** REMOVABLE START */
  render() {
    return (index.h("div", { class: this.setClasses() }, this.hasMediaLeading()
      ? index.h("eds-image", { notFitted: true, class: [
      ...
      : '', this.text
      ? index.h("div", { tabIndex: -1, class: `${this.classNames.EL}${this.classNames.TEXT}` }, this.text)
      : ''));
  }
  get el() { return index.getElement(this); }
};
...
const ENOVOSCheckbox = class {
  ...
  componentDidLoad() {
    ...
    this._clickHandler = new tapEvent.TapEvent(this.el, e => {
      this.clickHandler(e);
    }, 0);
  }
  componentDidUpdate() {
  ...
  render() {
    return (index.h("div", { class: [
        this.classNames.EL,
        this.getSize(),
        StylePropsHelper.StylePropsHelper.getStyles(this.getStyles(), this.classNames.EL),
      ].join(' ') }, index.h("input", { type: "checkbox", name: this.inputName, value: this.value }), index.h("div", { class: `${this.classNames.EL}${this.classNames.SHAPE}` }, index.h("div", { class: `${this.classNames.EL}${this.classNames.SHAPE}__inner` })), this.label
...
const ENOVOSChip = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.clickChip = index.createEvent(this, "clickChip", 7);
    this.clickTrailing = index.createEvent(this, "clickTrailing", 7);
    this.selected = false;
  ...
  handleEvent() {
    ...
    if (!this.isMotionless()) {
      ...
      this._clickHandler = new tapEvent.TapEvent(shape, e => {
        this.clickHandler(e);
      });
      if (this.trailingEvent) {
        ...
        if (trailingElement) {
          ...
          this._clickTrailingHandler = new tapEvent.TapEvent(trailingElement, e => {
            e.preventDefault();
  ...
  render() {
    return [
      index.h("input", { type: "radio", name: this.inputName, value: this.value }),
      index.h("button", { type: "button", class: [
        ...
        switch (this.leadingType) {
          case 'avatar':
            return index.h("eds-avatar", { src: this.leadingValue, size: this.size === 'sm' && this.sizeAvatar === undefined ? 'xs' : this.sizeAvatar, class: [
                `${this.classNames.EL}${this.classNames.AVATAR}`,
                `${this.classNames.EL}${this.classNames.LEADING}${this.classNames.ELEMENT}`,
              ].join(' ') });
          case 'icon':
            return index.h("eds-icon", { class: [
                `${this.classNames.EL}${this.classNames.ICON}`,
                `${this.classNames.EL}${this.classNames.LEADING}${this.classNames.ELEMENT}`,
        ...
        switch (this.trailingType) {
          case 'avatar':
            return index.h("eds-avatar", { src: this.trailingValue, size: this.size === 'sm' && this.sizeAvatar === undefined ? 'xs' : this.sizeAvatar, class: [
                `${this.classNames.EL}${this.classNames.AVATAR}`,
          ...
          case 'badge':
            return index.h("eds-badge", { class: [
...
class DropdownItem {
  constructor(obj) {
    ...
    this.uid = has$1.has(obj, 'id') ? _hasPath$1.get(obj, 'id') : v4.v4_1();
    // Add props
  ...
  getProp(key) {
    return _hasPath$1.get(this, key);
  }
  hasProp(key) {
    return has$1.has(this, key);
  }
  setProp(key, value) {
    set$1.set(this, key, value);
  }
}
...
const ENOVOSDropdown = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.clickDropdownItem = index.createEvent(this, "clickDropdownItem", 7);
    this.activeSelectorItem = index.createEvent(this, "activeSelectorItem", 7);
    this.data = [];
    this.elevationLevel = '2';
  ...
  setMainElementClasses() {
    return [
      ...
      ComponentPropsHelper.ComponentPropsHelper.setGlobalStyles([this.styles, this.font].join(' '), this.classNames.EL),
      this.isAvatarOnly(),
      this.getSize(),
    ].join(' ');
  }
  ...
  displayLeadingTrailingElement(item, type) {
    ...
    switch (item.getProp(`${type}.type`)) {
      case 'avatar':
        return index.h("eds-avatar", { src: item.getProp(`${type}.value`), size: "xs", class: [
  ...
  onMouseEventHandle(e, uid, hover) {
    ...
    if (hover === true) {
      ...
      this._observable = new isVisibleObservable.IsVisibleObservable(element, value => {
        if (value === true) {
  ...
  render() {
    return (index.h("div", { class: `${this.classNames.EL}${this.classNames.MAIN}` }, index.h("slot", { name: "selector" }), index.h("eds-elevation", { class: `${this.classNames.EL}${this.classNames.ELEVATION}`, styles: this.elevationStyles, level: this.elevationLevel, reverse: this.elevationReverse }, index.h("div", { class: this.setMainElementClasses() }, index.h("slot", { name: "header" }), (this.dropdownItems.length > 0) ?
      index.h("div", { class: this.setMainContainerClasses() }, this.dropdownItems.map(item => [
        index.h("div", { id: `dropdown_${item.getProp('uid')}`, onClick: () => this.clickDropdownItemHandler(item), onMouseOver: e => item.hasProp('subitems') ? this.onMouseEventHandle(e, item.getProp('uid'), true) : false, onMouseLeave: e => item.hasProp('subitems') ? this.onMouseEventHandle(e, item.getProp('uid'), false) : false, class: [
          ...
          ].join(' ') }, index.h("div", { class: this.setItemContainerClasses(item) }, this.displayLeadingTrailingElement(item, 'leading'), ((item.hasProp('label') && item.getProp('label').trim() !== ''))
          ? index.h("div", { class: `${this.classNames.EL}${this.classNames.ITEM}${this.classNames.TEXT}` }, item.getProp('label'))
          : ''), this.displayLeadingTrailingElement(item, 'trailing'), (item.hasProp('subitems')) ?
          index.h("eds-dropdown", { hasSubItems: true, elevationStyles: this.elevationStyles, elevationLevel: this.elevationLevel, size: this.size, class: `${this.classNames.EL}${this.classNames.SUBITEMS}`, data: item.getProp('subitems') })
          : ''),
        (item.hasProp('children')) ?
          index.h("eds-dropdown", { "elevation-level": "0", size: this.size, parent: item, indented: !item.hasProp('isHeading') || item.getProp('isHeading') !== true ? true : false, activeItem: this.activeItem, data: item.getProp('children') })
          : '',
        (item.getProp('separator') === true) ?
          index.h("hr", { class: `${this.classNames.EL}${this.classNames.SEPARATOR}` })
          : '',
      ]))
      : '', (this.controlItems) ?
      index.h("div", { class: this.setMainContainerClasses() }, index.h("eds-selection-controls", { id: this.controlItems.getProp('id'), type: this.controlItems.getProp('type'), data: this.controlItemsData }))
...
const ENOVOSInfoText = class {
  ...
  componentWillLoad() {
    this.uuid = `${this.classNames.EL}${this.classNames.TOOLTIP}--${v4.v4_1()}`;
  }
  /**
   * @description Init the host element and attach event
   */
  ...
  render() {
    return (index.h("div", { class: [
        this.classNames.EL,
        ComponentPropsHelper.ComponentPropsHelper.setGlobalStyles(this.infoStyles, this.classNames.EL),
      ].join(' ') }, this.infoText !== undefined ? index.h("span", null, this.infoText) : '', this.infoTooltipIcon !== undefined ?
      index.h("eds-icon", { id: this.uuid, class: [
          `${this.classNames.EL}${this.classNames.ICON}`,
        ].join(' '), icon: this.infoTooltipIcon, size: this.infoTooltipSize, styles: this.infoTooltipStyles })
      : '', this.infoTooltipText !== undefined ?
      index.h("eds-tooltip", { class: [
...
const ENOVOSInput = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.focusInput = index.createEvent(this, "focusInput", 7);
    this.blurInput = index.createEvent(this, "blurInput", 7);
    this.changeInput = index.createEvent(this, "changeInput", 7);
    this.inputInput = index.createEvent(this, "inputInput", 7);
    this.changeFileInput = index.createEvent(this, "changeFileInput", 7);
    this.dataName = '';
    this.debounce = 0;
    this.step = '1';
    this.ellipsis = false;
     ...
     */
    this.typing = debounce.debounce(ev => {
   ...
   */
  isActive() {
    return (!isEmpty.isEmpty(this.dataValue)) ? `${this.classNames.EL}--filled` : '';
  }
  /**
...
const ENOVOSLink = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.clickLink = index.createEvent(this, "clickLink", 7);
    this.target = '_self';
    this.hasIcon = false;
  ...
  render() {
    return (index.h("a", { class: [
        ...
        this.getEmailClass(),
        this.getSize(),
        ComponentPropsHelper.ComponentPropsHelper.setGlobalStyles(this.getStylesAttributes(), this.classNames.EL),
      ...
      }, target: this.target }, index.h("div", { class: `${this.classNames.EL}${this.classNames.CONTENT}`, tabIndex: -1 }, index.h("slot", { name: "icon" }), index.h("slot", { name: "button" }), index.h("div", { class: "text", innerHTML: (this.content ? this.content : (this.url ? this.url : this.mailto)) }))));
  }
  get el() { return index.getElement(this); }
};
...
const ENOVOSPositionedBadge = class {
  ...
  componentDidRender() {
    ...
    if (this.additionalMargin || this.additionalMargin !== undefined) {
      ...
      this.el.querySelector(`.${this.classNames.EL}`).classList.add(ComponentPropsHelper.ComponentPropsHelper.getSize(additionalMargin, `${this.classNames.EL}${this.classNames.MARGIN}`));
    }
    if (this.corner) {
  ...
  render() {
    return (index.h("div", { class: [
        this.classNames.EL,
      ].join(' ') }, index.h("eds-badge", { class: `${this.classNames.EL}${this.classNames.BADGE}`, text: this.text, size: this.size, rounded: this.rounded, styles: this.styles }), index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
...
const ENOVOSPositionedIcon = class {
  ...
  render() {
    return (index.h("div", { class: [
      ...
      ].join(' ') }, index.h("eds-icon", { class: [
        `${this.classNames.EL}${this.classNames.ICON}`,
        this.backgroundColor ? ComponentPropsHelper.ComponentPropsHelper.setGlobalStyles(`bg--${this.backgroundColor}`, `${this.classNames.EL}`) : '',
      ].join(' '), size: this.size, styles: this.styles, icon: this.icon }), index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
...
const ENOVOSRadioButton = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.clickRadioButton = index.createEvent(this, "clickRadioButton", 7);
    this.selected = false;
    this.disabled = false;
    this.classNames = {
      EL: 'radio-button',
  ...
  render() {
    return (index.h("div", { class: [
        ...
        this.getSize(),
        StylePropsHelper.StylePropsHelper.getStyles(this.styles, this.classNames.EL),
      ].join(' ') }, index.h("input", { type: "radio", name: this.inputName, value: this.value }), index.h("div", { class: [
        `${this.classNames.EL}${this.classNames.SHAPE}`,
        this.hasIconClass(),
      ].join(' ') }, this.icon
      ? index.h("eds-icon", { class: `${this.classNames.EL}${this.classNames.SHAPE}${this.classNames.ICON}`, icon: this.icon })
      : ''), this.label
      ? index.h("label", null, this.label)
      : ''));
  }
...
const ENOVOSSelect = class {
  ...
  /** REMOVABLE START */
  render() {
    return (index.h("select", { name: this.dataName, required: this.required, class: [
        this.classNames.EL,
        StylePropsHelper.StylePropsHelper.getStyles(this.styles, this.classNames.EL),
      ].join(' ') }, this.options.map(value => {
      return (index.h("option", { value: value, selected: value === this.dataValue ? true : false }, value));
    })));
  }
  get el() { return index.getElement(this); }
};
...
const ENOVOSSelectionControls = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.clickSelectionControlItem = index.createEvent(this, "clickSelectionControlItem", 7);
    this.clickSelectionControls = index.createEvent(this, "clickSelectionControls", 7);
    this.data = [];
    this.indented = false;
    this.items = [];
    this.classNames = {
  ...
  async clearData() {
    const itemsTmp = compact.compact(concat.concat(this.items, uniq.uniq((flatten.flatten(map.map(this.items, 'children'))).slice().sort())));
    itemsTmp.map(item => {
      item.selected = false;
      if (has$1.has(item, 'indeterminate')) {
  ...
  foundOriginalItem(items, id) {
    return find.find(compact.compact(concat.concat(items, uniq.uniq((flatten.flatten(map.map(items, 'children'))).slice().sort()))), (item) => (item.getProp(`id`) === id));
  }
  getSelectedItems(items) {
    return filter.filter(compact.compact(concat.concat(items, uniq.uniq((flatten.flatten(map.map(items, 'children'))).slice().sort()))), (item) => (item.getProp(`selected`) === true));
  }
  /**
   * @description Init the dropdown from an array of item
   */
    ...
    if (Array.isArray(items)) {
      items.map(item => {
        if (item) {
          ...
          formatItem.id = (!has$1.has(item, 'id')) ? `${this.prefixId}${uniqueId.uniqueId()}` : `${this.prefixId}${_hasPath$1.get(item, 'id')}`;
          if (has$1.has(item, 'children')) {
            formatItem.children = this.setItems(_hasPath$1.get(item, 'children'));
          }
  ...
  setIndeterminateState(item, forceIndeterminate, forceSelected) {
    ...
    if (item.hasProp('children')) {
      ...
      const nbCheckedChildren = filter.filter(item.getProp('children'), (child) => child.getProp('selected') === true);
  ...
  render() {
    return (index.h("div", { class: this.setMainElementClasses() }, (() => {
      switch (this.type) {
        case 'checkbox':
          return this.items.map((item) => {
            return [
              index.h("eds-checkbox", { class: [
                  `${this.classNames.EL}${this.classNames.ITEM}`,
              ...
              (item.hasProp('children')) ?
                index.h("eds-selection-controls", { indented: true, refresh: this.refresh, data: item.getProp('children'), type: this.type })
                : '',
            ];
          });
        case 'radio-button':
          return this.items.map((item) => {
            return index.h("eds-radio-button", { class: [
                `${this.classNames.EL}${this.classNames.ITEM}`,
                item.getProp(`selected`) === true ? `${this.classNames.EL}${this.classNames.ITEM}${this.classNames.SELECTED}` : '',
        ...
        case 'switch':
          return this.items.map((item) => {
            return index.h("eds-switch", { class: [
                `${this.classNames.EL}${this.classNames.ITEM}`,
...
const ENOVOSSwitch = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.clickSwitch = index.createEvent(this, "clickSwitch", 7);
  ...
  render() {
    return [
      this.label
        ? index.h("eds-paragraph", { type: "body-1", styles: this.checked === true ? 'secondary-500' : 'tertiary-500', fontWeight: this.checked === true ? 'bold' : 'regular', content: this.label })
        : '',
      index.h("div", { class: [
          this.classNames.EL,
          (this.disabled) ? `${this.classNames.EL}--disabled` : '',
          this.getSize(),
          ComponentPropsHelper.ComponentPropsHelper.setGlobalStyles(this.styles, this.classNames.EL),
        ].join(' ') }, index.h("input", { type: "checkbox", name: this.inputName, value: this.value }), index.h("label", { class: `${this.classNames.EL}${this.classNames.TRACK}` }, index.h("eds-elevation", { styles: (this.disabled) ? 'light' : 'dark', level: this.elevationLevel }, index.h("span", { class: `${this.classNames.EL}${this.classNames.TRACK}${this.classNames.THUMB}` })))),
    ];
  }
  get el() { return index.getElement(this); }
};
...
const ENOVOSTabs = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.clickTabsItem = index.createEvent(this, "clickTabsItem", 7);
    this.border = false;
    this.items = [];
    this.tabItems = [];
    this.classNames = {
      ...
      this.tabItems.map((tabItem, index) => {
        if (tabItem.hasProp('id')) {
          ...
          if (item) {
            ...
            this._clickItemHandler[index] = new tapEvent.TapEvent(item, e => {
  ...
  getActiveItemClasses(item) {
    ...
    return [
      ComponentPropsHelper.ComponentPropsHelper.setGlobalStyles(this.styles, `${this.classNames.EL}${this.classNames.ITEM}`),
      activeClass,
    ].join(' ');
  }
  /**
  ...
  render() {
    if (this.tabItems.length > 0) {
      return (index.h("ul", { class: [
          ...
          this.hasBorder(),
          this.isSeparated(),
          StylePropsHelper.StylePropsHelper.getStyles(this.backgroundStyles, `${this.classNames.EL}--bg`),
        ].join(' ') }, this.tabItems.map(item => index.h("li", { tabindex: "-1", id: `tab_${item.getProp('id')}`, class: [
          `${this.classNames.EL}${this.classNames.ITEM}`,
          this.getActiveItemClasses(item),
          this.isDisabledItemClass(item),
        ].join(' ') }, item.hasProp('badge')
        ? index.h("eds-positioned-badge", { size: item.badge.size, styles: item.badge.styles, text: item.badge.text, position: item.badge.position, alignment: item.badge.alignment ? item.badge.alignment : 'inside' }, index.h("div", { class: "tabs__item__content" }, item.hasProp('title') && !item.hasProp('icon') ? item.getProp('title') : '', item.hasProp('icon') && !item.hasProp('title')
        ...
        : item.hasProp('positionedIcon')
          ? index.h("eds-positioned-icon", { size: item.positionedIcon.size, styles: item.positionedIcon.styles, icon: item.positionedIcon.icon, backgroundColor: item.positionedIcon.backgroundColor, position: item.positionedIcon.position, alignment: item.positionedIcon.alignment ? item.positionedIcon.alignment : 'inside' }, index.h("div", { class: "tabs__item__content" }, item.hasProp('title') && !item.hasProp('icon') ? item.getProp('title') : '', item.hasProp('icon') && !item.hasProp('title')
            ? index.h("div", { class: `${this.classNames.EL}${this.classNames.ITEM}${this.classNames.ICON__CONTAINER}` }, index.h("eds-icon", { class: [
                `${this.classNames.EL}${this.classNames.ITEM}${this.classNames.ICON}`,
              ].join(' '), styles: item.getProp('icon.styles'), size: item.hasProp('icon.size') ? item.getProp('icon.size') : '5x', icon: item.getProp('icon.icon') }))
            : ''))
          : index.h("div", { class: "tabs__item__content" }, item.hasProp('title') && !item.hasProp('icon') ? item.getProp('title') : '', item.hasProp('icon') && !item.hasProp('title')
            ? index.h("div", { class: `${this.classNames.EL}${this.classNames.ITEM}${this.classNames.ICON__CONTAINER}` }, index.h("eds-icon", { class: [
                `${this.classNames.EL}${this.classNames.ITEM}${this.classNames.ICON}`,
              ].join(' '), styles: item.getProp('icon.styles'), size: item.hasProp('icon.size') ? item.getProp('icon.size') : '5x', icon: item.getProp('icon.icon') }))
            : '')))));
...
const ENOVOSFormItem = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.clickIconTrailing = index.createEvent(this, "clickIconTrailing", 7);
    this.clickIconLeading = index.createEvent(this, "clickIconLeading", 7);
    this.clickButtonTrailing = index.createEvent(this, "clickButtonTrailing", 7);
    this.clickForgetPassword = index.createEvent(this, "clickForgetPassword", 7);
    this.cleaningField = index.createEvent(this, "cleaningField", 7);
    this.typingField = index.createEvent(this, "typingField", 7);
    this.changeFiles = index.createEvent(this, "changeFiles", 7);
    this.disabled = false;
    this.readOnly = false;
    this.ellipsis = false;
  ...
  setTabsField() {
    if (this.hasTabs()) {
      ...
      if (tabs) {
        ...
        if (firstItem && has$1.has(firstItem, 'id')) {
          this.activeTab = _hasPath$1.get(firstItem, 'id');
        }
  ...
  clickTabsItemHandler(event) {
    ...
    if (item && item instanceof TabsItem && item.hasProp('id')) {
      ...
      // Refresh dataValue
      const targetTab = find.find(this.tabFields, { 'id': this.activeTab });
      if (!targetTab) {
  ...
  setTabConfig(id, value) {
    const tabItem = find.find(this.tabFields, { 'id': id });
    if (tabItem) {
      tabItem.value = value;
    }
    else {
  ...
  render() {
    return (index.h("div", { class: [
      ...
      ? index.h("eds-label", { styles: this.labelStyles, size: this.size, class: [this.classNames.EL + this.classNames.LABEL].join(' ') }, this.label)
      : '', this.hasTabs()
      ? index.h("eds-tabs", { class: [
      ...
      ? index.h("eds-input", { type: this.type, ellipsis: this.ellipsis, step: this.step, class: `${this.classNames.EL}${this.classNames.FIELD}${this.classNames.COMPONENT}`, disabled: this.disabled, "read-only": this.readOnly, debounce: this.debounce, dataName: this.dataName, dataValue: this.dataValue, styles: this.getStylesAttributes(), size: this.size, placeholder: this.placeholder })
      : '', ['select'].includes(this.inputType)
      ? index.h("eds-select", { options: this.options, class: `${this.classNames.EL}${this.classNames.FIELD}${this.classNames.COMPONENT}`, disabled: this.disabled, dataName: this.dataName, dataValue: this.dataValue, styles: this.getStylesAttributes() })
      : '')), this.hasIconTrailing()
      ? index.h("eds-icon", { onClick: ev => this.onClickIconTrailingHandler(ev), class: [
          this.classNames.EL + this.classNames.ICON,
      ...
      ? index.h("eds-button", { onClickButton: ev => this.onClickButtonTrailingHandler(ev), styles: has$1.has(this.trailingButton, `styles`) ? _hasPath$1.get(this.trailingButton, `styles`) : '', size: has$1.has(this.trailingButton, `size`) ? _hasPath$1.get(this.trailingButton, `size`) : 'sm', outlined: has$1.has(this.trailingButton, `outlined`) ? _hasPath$1.get(this.trailingButton, `size`) : false, textOnly: has$1.has(this.trailingButton, `textOnly`) ? _hasPath$1.get(this.trailingButton, `textOnly`) : false, class: [
          `${this.classNames.EL}${this.classNames.BUTTON}`,
          `${this.classNames.EL}${this.classNames.BUTTON}${this.classNames.TRAILING}`,
        ].join(' ') }, has$1.has(this.trailingButton, `icon`) ?
        index.h("eds-icon", { slot: "icon", icon: _hasPath$1.get(this.trailingButton, `icon`) })
        : '')
      : '', this.hasIconShowHide() && this.trailingButton === undefined
      ? index.h("eds-button", { styles: "quaternary", class: [
        ...
        ].join(' '), size: "sm" }, index.h("eds-icon", { slot: "icon", icon: this.icons.SHOW }))
      : '', this.hasIconShowHide()
      ? index.h("eds-link", { onClick: ev => this.onClickForgetPasswordHandler(ev), class: [
          (this.dataValue !== '') ? `${this.classNames.EL}--hidden` : `${this.classNames.EL}--visible`,
          `${this.classNames.EL}${this.classNames.LINK}`,
        ].join(' '), size: "sm", styles: this.getLinkColor(), content: this.forgetLinkText })
      : '', this.hasClearButton()
      ? index.h("eds-icon", { onClick: ev => this.cleanFieldHandler(ev), class: [
          this.classNames.EL + this.classNames.ICON,
          this.classNames.EL + this.classNames.ICON + this.classNames.ICON_CLEANING,
        ].join(' '), icon: "times" })
      : ''), this.displayError()
      ? index.h("eds-assistive-text", { class: this.classNames.EL + this.classNames.ASSISTIVE_TEXT, styles: this.getStylesAttributes(), icon: this.iconAssistiveText, message: this.assistiveTextMessage.message, code: this.assistiveTextMessage.code, type: this.assistiveTextMessage.type })
      : ''));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const ENOVOSTooltip = class {
  ...
  isInViewPort() {
    ...
    return isEqual.isEqual(this.finalPlacement.sort(), this.revertPlacement.sort());
  }
  // Get size
  getSize() {
    return (this.size !== undefined) ? `${this.classNames.EL}--${this.size}` : '';
  ...
  /** REMOVABLE START */
  render() {
    return (index.h("div", { tabIndex: -1, class: [
        this.classNames.EL,
        this.pointer ? `${this.classNames.EL}${this.classNames.POINTER}` : '',
        this.getSize(),
        StylePropsHelper.StylePropsHelper.getStyles(this.styles, this.classNames.EL),
      ].join(' ') }, index.h("eds-elevation", { class: `${this.classNames.EL}${this.classNames.CONTENT}`, styles: this.elevationStyle, level: this.elevationLevel }, index.h("div", { class: `${this.classNames.EL}${this.classNames.CONTENT}${this.classNames.TEXT}` }, this.text ? this.text : ''), this.pointer ?
      index.h("div", { class: `${this.classNames.EL}${this.classNames.CONTENT}${this.classNames.POINTER}` })
      : '')));
  }
  get el() { return index.getElement(this); }
};
...
exports.eds_assistive_text = ENOVOSFieldHelper;
exports.eds_avatar = ENOVOSAvatar;
exports.eds_badge = ENOVOSBadge;
exports.eds_checkbox = ENOVOSCheckbox;
exports.eds_chip = ENOVOSChip;
exports.eds_dropdown = ENOVOSDropdown;
exports.eds_info = ENOVOSInfoText;
exports.eds_input = ENOVOSInput;
exports.eds_label = ENOVOSLabel;
exports.eds_link = ENOVOSLink;
exports.eds_positioned_badge = ENOVOSPositionedBadge;
exports.eds_positioned_icon = ENOVOSPositionedIcon;
exports.eds_radio_button = ENOVOSRadioButton;
exports.eds_select = ENOVOSSelect;
exports.eds_selection_controls = ENOVOSSelectionControls;
exports.eds_switch = ENOVOSSwitch;
exports.eds_tabs = ENOVOSTabs;
exports.eds_text_field = ENOVOSFormItem;
exports.eds_tooltip = ENOVOSTooltip;
